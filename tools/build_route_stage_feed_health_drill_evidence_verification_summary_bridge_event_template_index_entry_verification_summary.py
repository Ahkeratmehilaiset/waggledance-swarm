...
"""Render a path-free route-stage bridge-template index-entry verifier summary."""
...
def build_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry_verification_summary(
    *,
    ...
    summary = {
        ...
        "reviewer_next_actions": [
            "review_route_stage_feed_health_bridge_template_index_entry_verification_summary",
...
def render_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry_verification_summary_markdown(
    ...
    lines = [
        "# Route-Stage Feed-Health Index-Entry Verification Summary",
        "",
