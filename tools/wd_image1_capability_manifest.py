    ...
    return (
        ...
        Capability(
            ...
            gaps=(
                ...
                "bridge-event template plus local index entry add reviewer "
            ...
            next_smallest_pr=(
                ...
                "digest bridge-event template index entry verifier-summary "
                "bridge-event template index entry without including "
