...
LEAK_PATTERNS = (
    ...
    re.compile(
        r"\b(?:anthropic|claude|cohere|command|command-r|deepseek|falcon|gemini|gemma|google|gpt|grok|hf|huggingface|llama|mistral|mixtral|mpt|ollama|openai|phi|poro|qwen|xai|yi)[A-Za-z0-9_.:/-]*\b",
        re.IGNORECASE,
    ),
)
