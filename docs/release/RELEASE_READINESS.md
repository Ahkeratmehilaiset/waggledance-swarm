# Release Readiness — WaggleDance (v3.8.0 stable + v3.9.0-producer-fabric-alpha PRERELEASE + v3.9.1-local-efficiency-benchmark-alpha PRERELEASE + v3.9.2-local-ollama-baseline-alpha PRERELEASE)
