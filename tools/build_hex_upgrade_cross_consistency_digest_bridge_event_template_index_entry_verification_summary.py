...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--now",
        default=None,
        help="Optional UTC timestamp override such as 2026-06-20T09:05:00Z.",
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.json:
        ...
        print(
            "hex cross-consistency index-entry verification summary FAILED: "
    ...
    *,
    ...
    summary = {
        ...
        "hex_upgrade_cross_consistency_digest_bridge_event_template_index_entry_verification": {
            ...
            "digest_ref_check": _check_status(
                verification_report.get("digest_ref_check")
            ),
        ...
        "reviewer_next_actions": [
            "review_hex_cross_consistency_index_entry_verification_summary",
...
def render_hex_upgrade_cross_consistency_digest_bridge_event_template_index_entry_verification_summary_markdown(
    ...
    lines = [
        ...
        f"- Digest ref check: `{verification.get('digest_ref_check')}`",
...
def _assert_no_forbidden_output(text: str) -> None:
    if _forbidden_output_markers(text):
        raise ValueError(
            "hex cross-consistency index-entry verification summary contains "
            "forbidden markers"
        )
