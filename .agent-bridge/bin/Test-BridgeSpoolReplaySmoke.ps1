...
$sessionIdentityScript = Join-Path $PSScriptRoot 'AgentBridgeSessionIdentity.ps1'
$previousBridgeAgent = [Environment]::GetEnvironmentVariable(
    'AGENT_BRIDGE_AGENT',
    'Process'
)
...
try {
    ...
    [Environment]::SetEnvironmentVariable(
        'AGENT_BRIDGE_AGENT', 'smoke-1', 'Process'
    )
    ...
    $isolatedSessionIdentity = Join-Path $isolatedBin `
    ...
    Copy-Item -LiteralPath $sessionIdentityScript `
        -Destination $isolatedSessionIdentity
...
'@
    ...
    [Environment]::SetEnvironmentVariable(
        'AGENT_BRIDGE_AGENT', $previousBridgeAgent, 'Process'
    )
    [Environment]::SetEnvironmentVariable(
