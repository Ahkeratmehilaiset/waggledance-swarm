...
"""Verify a runtime-gap verifier-summary bridge-template index entry."""
...
from tools.build_runtime_gap_scheduler_candidate_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry import (  # noqa: E402
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.json or report["ok"]:
        ...
        print(
            "runtime-gap verifier-summary bridge-template index entry "
            "verification FAILED: "
...
def verify_runtime_gap_scheduler_candidate_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry(
    *,
