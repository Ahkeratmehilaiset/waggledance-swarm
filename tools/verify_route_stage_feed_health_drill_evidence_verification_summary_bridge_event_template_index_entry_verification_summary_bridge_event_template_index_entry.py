...
"""Verify a route-stage verifier-summary bridge-template index entry."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.json or report["ok"]:
        ...
        print(
            "route-stage verifier-summary bridge-template index entry "
            "verification FAILED: "
...
def verify_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry(
    *,
