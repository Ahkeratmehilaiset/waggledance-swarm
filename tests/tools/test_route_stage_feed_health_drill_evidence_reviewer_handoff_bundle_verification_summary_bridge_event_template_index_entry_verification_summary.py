...
def test_route_stage_handoff_bundle_template_index_entry_verification_summary_markdown_is_path_free() -> None:
    ...
    markdown = render_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_markdown(
        summary
    )

    assert "Route-Stage Handoff Bundle Template Index-Entry Verification Summary" in markdown
