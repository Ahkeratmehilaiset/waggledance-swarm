...
release decision. The next small step is adding an operator-owned reviewer
handoff summary for validated evidence without adding approval automation.
