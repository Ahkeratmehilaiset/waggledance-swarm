...
"""Build a runtime-gap verifier-summary bridge-event-template index entry."""
...
from tools.build_runtime_gap_scheduler_candidate_bridge_event_template_index_entry import (  # noqa: E402
    ARTIFACT_ID as SOURCE_INDEX_ARTIFACT_ID,
    AUTHORITY_FALSE_FIELDS,
    FORBIDDEN_OUTPUT_MARKERS,
    INDEX_ENTRY_VERSION as SOURCE_INDEX_ENTRY_VERSION,
    TEMPLATE_ARTIFACT_ID as SOURCE_TEMPLATE_ARTIFACT_ID,
)
from tools.build_runtime_gap_scheduler_candidate_bridge_event_template_index_entry_verification_summary import (  # noqa: E402
    SUMMARY_VERSION as SOURCE_SUMMARY_VERSION,
)
from tools.build_runtime_gap_scheduler_candidate_bridge_event_template_index_entry_verification_summary_bridge_event_template import (  # noqa: E402
...
INDEX_ENTRY_VERSION = (
    "waggledance.runtime_gap_scheduler_candidate_bridge_event_template_"
...
_OUTPUT_FALSE_FIELDS = _RUNTIME_FALSE_FIELDS
_FALSE_FIELD_KEYS = tuple(dict.fromkeys((*AUTHORITY_FALSE_FIELDS, *_RUNTIME_FALSE_FIELDS)))
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--now",
        default=None,
        help="Optional UTC timestamp override such as 2026-06-11T08:20:00Z.",
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        report = build_runtime_gap_scheduler_candidate_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry(
    ...
    if args.json or report["ok"]:
        ...
        print(
            "runtime-gap verifier-summary bridge-event-template index entry "
            "FAILED: "
...
def build_runtime_gap_scheduler_candidate_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry(
    *,
    ...
    verification = _mapping(
        index_entry_verification_summary.get(RUNTIME_GAP_VERIFICATION_KEY)
    )
    ...
    entry = {
        ...
        "reviewer_next_actions": [
            "review_runtime_gap_verifier_summary_bridge_event_template_index_entry",
...
def _rebuilt_summary_bridge_template(
    ...
    rebuilt = build_runtime_gap_scheduler_candidate_bridge_event_template_index_entry_verification_summary_bridge_event_template(
        summary=summary,
...
def _assert_template_report_contract(
    ...
    *,
    ...
    payload_verification = _mapping(payload.get(RUNTIME_GAP_VERIFICATION_KEY))
...
def _summary_contract_blockers(summary: Mapping[str, Any]) -> list[str]:
    ...
    verification = _mapping(summary.get(RUNTIME_GAP_VERIFICATION_KEY))
