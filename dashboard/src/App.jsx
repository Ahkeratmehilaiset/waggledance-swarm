...
export default function App(){
  ...
  useEffect(() => {
    fetch("/api/language", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ mode: lang }) }).catch(() => {});
  }, [lang]);
