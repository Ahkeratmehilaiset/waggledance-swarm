...
| Category | Mode | Count |
|---|---|---|
| chat_response_failure | WARM | 1942 |
| health_failure | COLD | 210 |
| chat_failure | COLD | 121 |
| backend_unhealthy | HOT | 19 |
| cycle_crash_recovery | WARM | 19 |
| chat_send_failure | WARM | 11 |
| auth_recovery_failure | WARM | 11 |
