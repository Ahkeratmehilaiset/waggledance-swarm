...
"""Render a route-stage reviewer handoff verifier-summary index verifier summary."""
...
PROOF_ID = (
    ...
    "verification_summary_bridge_event_template_index_entry_verification_summary_"
    "bridge_event_template_index_entry_verification_summary_v1"
)
VERIFICATION_KEY = (
    "route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_"
    "verification_summary_bridge_event_template_index_entry_verification_summary_"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--now",
        default=None,
        help="Optional UTC timestamp override such as 2026-06-20T00:30:00Z.",
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.json:
        ...
        print(
            ...
            "bridge-template index-entry verification summary FAILED: "
...
def build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary(
    *,
    ...
    """Return path-free reviewer context for a verifier-summary index check."""
    ...
    summary = {
        ...
        "reviewer_next_actions": [
            "review_route_stage_reviewer_handoff_bundle_verifier_summary_bridge_template_index_entry_verification_summary",
            "compare_verifier_summary_bridge_template_index_entry_verification_to_local_artifacts",
...
def render_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_markdown(
    ...
    lines = [
        "# Route-Stage Reviewer Handoff Verifier-Summary Index Verification Summary",
        "",
        ...
        "",
        "## Verifier-Summary Index Verification",
        "",
...
def _assert_no_forbidden_output(text: str) -> None:
    if _forbidden_output_markers(text):
        raise ValueError(
            "route-stage reviewer handoff bundle verifier-summary "
            "bridge-template index-entry verification summary contains "
            "forbidden markers"
        )
