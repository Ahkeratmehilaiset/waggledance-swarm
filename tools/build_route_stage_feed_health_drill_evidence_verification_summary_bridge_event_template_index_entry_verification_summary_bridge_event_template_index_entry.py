...
"""Build a route-stage verifier-summary bridge-event-template index entry."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        report = build_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry(
    ...
    if args.json or report["ok"]:
        ...
        print(
            "route-stage verifier-summary bridge-event-template index entry "
            "FAILED: "
...
def build_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry(
    *,
    ...
    verification = _mapping(
        index_entry_verification_summary.get(ROUTE_STAGE_VERIFICATION_KEY)
    )
...
def _rebuilt_summary_bridge_template(
    ...
    rebuilt = build_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template(
        summary=summary,
...
def _assert_template_report_contract(
    ...
    *,
    ...
    payload_verification = _mapping(payload.get(ROUTE_STAGE_VERIFICATION_KEY))
