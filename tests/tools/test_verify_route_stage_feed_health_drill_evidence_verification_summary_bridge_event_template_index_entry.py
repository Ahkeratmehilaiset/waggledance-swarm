...
def test_route_stage_feed_health_verification_summary_bridge_event_template_index_entry_verifier_recomputes_digests_without_authority() -> None:
    artifacts = _artifact_set()
    index_entry = _index_entry(artifacts)
    raw = _artifact_bytes(artifacts)

    report = verify_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry(
...
def test_route_stage_feed_health_verification_summary_bridge_event_template_index_entry_verifier_cli_json_is_path_free(
    tmp_path: Path,
) -> None:
    artifacts = _artifact_set()
    index_entry = _index_entry(artifacts)
...
def test_route_stage_feed_health_verification_summary_bridge_event_template_index_entry_verifier_rejects_digest_mismatch_path_free(
    tmp_path: Path,
) -> None:
    artifacts = _artifact_set()
    index_entry = _index_entry(artifacts)
...
def test_route_stage_feed_health_verification_summary_bridge_event_template_index_entry_verifier_rejects_missing_record() -> None:
    artifacts = _artifact_set()
    index_entry = _index_entry(artifacts)
...
def test_route_stage_feed_health_verification_summary_bridge_event_template_index_entry_verifier_rejects_nested_authority() -> None:
    artifacts = _artifact_set()
    index_entry = _index_entry(artifacts)
...
def test_route_stage_feed_health_verification_summary_bridge_event_template_index_entry_verifier_rejects_deterministic_entry_drift() -> None:
    artifacts = _artifact_set()
    index_entry = _index_entry(artifacts)
...
def test_route_stage_feed_health_verification_summary_bridge_event_template_index_entry_verifier_rejects_source_contract_forgery() -> None:
    artifacts = _artifact_set()
    index_entry = _index_entry(artifacts)
...
def test_route_stage_feed_health_verification_summary_bridge_event_template_index_entry_verifier_missing_input_is_path_free(
    tmp_path: Path,
) -> None:
    artifacts = _artifact_set()
    index_entry = _index_entry(artifacts)
...
def test_route_stage_feed_health_verification_summary_bridge_event_template_index_entry_verifier_non_finite_json_is_path_free(
    tmp_path: Path,
) -> None:
    artifacts = _artifact_set()
    index_entry = _index_entry(artifacts)
...
def _artifact_set() -> dict[str, dict]:
    ...
    template = build_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template(
        ...
        task_id="wd-image1-route-stage-feed-template-index-verifier",
