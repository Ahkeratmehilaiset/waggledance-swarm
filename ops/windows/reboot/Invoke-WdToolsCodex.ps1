...
$reasoningEffort = [string]$env:WD_TOOLS_CODEX_REASONING_EFFORT
if ($reasoningEffort -cnotin @('low', 'medium', 'high', 'xhigh', 'max')) {
    throw 'WD_TOOLS_CODEX_REASONING_EFFORT is missing or invalid'
}
$forwardArguments.Insert(0, '-c')
$forwardArguments.Insert(
    1,
