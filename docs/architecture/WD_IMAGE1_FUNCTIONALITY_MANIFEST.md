...
decision, or runtime controls. The next small step is adding reviewer-side
validation for packaged release evidence without adding transport or controls.
