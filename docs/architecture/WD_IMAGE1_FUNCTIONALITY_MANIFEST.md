...
This route-stage feed-health drill evidence chain remains context-only: it
does not append bridge events, include payloads, record local paths, call
external endpoints, grant approval, or add runtime controls.
