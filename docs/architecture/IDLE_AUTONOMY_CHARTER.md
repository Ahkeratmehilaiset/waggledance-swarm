...
* `tools/bridge_event_writer.py` (canonical Python bridge-event writer — self-modification banned; changes to the durable append boundary require operator review)
