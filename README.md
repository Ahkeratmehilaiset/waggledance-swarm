...
Validated with 79 legacy suites (1472 tests) and 2747 pytest tests — 4219 total, 0 failures, Health 100/100. No subscription, no API keys required.
...
├── tests/               # 79 legacy suites + 2747 pytest tests (~4219 total)
...
| Metric | Value | Notes |
|--------|-------|-------|
| Test suites | 79 legacy suites + 2747 pytest | ~4219 total tests, 4 skipped without Ollama |
