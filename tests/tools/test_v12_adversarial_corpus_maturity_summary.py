...
def test_summary_reports_mature_adversarial_corpus_without_authority() -> None:
    ...
    # Locked counts: hallucinated-success expansion 2026-06-10 (59 -> 63),
    # path_escape expansion 2026-06-10 (63 -> 67),
    # regression-process expansion 2026-06-10 (67 -> 71),
    # fail-open expansion 2026-06-10 (71 -> 75),
    # governance_bypass expansion 2026-06-10 (75 -> 79),
    # spec-gaming expansion 2026-06-10 (79 -> 83; all critical families now >= 6).
    # correlated_review_trap expansion 2026-06-10 (83 -> 87; rollup-recommended).
    # policy_bypass expansion 2026-06-10 (87 -> 91; rollup-recommended, stacked).
    # privilege_leak expansion 2026-06-10 (91 -> 95; rollup-recommended, stacked).
    # risk_escalation expansion 2026-06-10 (95 -> 99; last family at 3; none < 5 now).
    # path_escape tail-floor expansion 2026-06-11 (99 -> 100; path_escape 6 -> 7).
    ...
    # charter_violation tail-floor expansion 2026-06-11 (102 -> 103; charter_violation 5 -> 6).
    assert maturity["case_count"] == 103
    assert maturity["defect_type_count"] == 15
    assert maturity["held_out_case_count"] == 6
    assert maturity["privacy_canary_count"] == 89
    assert maturity["peer_review_trap_count"] == 101
...
def test_markdown_carries_maturation_targets_and_authority_boundary() -> None:
    ...
    assert "cases: `103/50`" in markdown
...
def test_cli_json_smoke() -> None:
    ...
    assert payload["maturity"]["case_count"] == 103
