...
no-runtime-subdivision-authority boundary. The next small step is a local
index entry for that verification summary bridge-event template without
appending it.
