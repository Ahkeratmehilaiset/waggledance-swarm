...
summary, and verifier-summary bridge-event template continue that same review
...
step is a local index entry for that verifier-summary bridge-event template.
