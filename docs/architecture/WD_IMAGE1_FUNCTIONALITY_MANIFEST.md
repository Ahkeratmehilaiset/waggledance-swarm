...
`automatic_release_decision=false`. The next small step is adding an optional
bridge-event template for reviewer handoff summaries without automatic
approval or release actions.
