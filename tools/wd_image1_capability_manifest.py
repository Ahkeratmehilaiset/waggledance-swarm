    ...
    return {
        **base,
        ...
        "safe_conclusion": (
            ...
            "renderer without storing raw query, profile, language, context, "
    ...
    return (
        Capability(
            ...
            safe_statement=(
                ...
                "bundle summary and a local index entry for that renderer; exact "
            ...
            next_smallest_pr=(
                ...
                "handoff bundle verification-summary bridge-event template "
