...
lapi. 48 MAGMA-event-tyyppia kaytossa.
...
of the 48 MAGMA event types. Run `python tools/audit_v3_13_0_event_surface.py`
...
python tools/audit_v3_13_0_event_surface.py --count-only   # expect: 48
```
