...
| Category | Mode | Count |
|---|---|---|
| chat_response_failure | WARM | 1742 |
| health_failure | COLD | 148 |
| chat_failure | COLD | 109 |
| backend_unhealthy | HOT | 13 |
| cycle_crash_recovery | WARM | 8 |
| tab_switch_failure | WARM | 6 |
| chat_send_failure | WARM | 4 |
| chat_failure | HOT | 3 |
| auth_bootstrap_failure | WARM | 1 |
| auth_recovery_failure | WARM | 1 |
