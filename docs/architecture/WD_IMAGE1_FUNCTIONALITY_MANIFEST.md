...
while preserving the same no-approval/no-release-decision boundary. The next
small step is adding a local operator decision-reference review bundle index
