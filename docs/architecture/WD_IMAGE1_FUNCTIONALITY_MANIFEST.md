...
preserving the same no-payload/no-path/no-transport/no-approval boundary. The
next small step is adding a local operator decision-reference review bundle
verification summary without granting approval.
