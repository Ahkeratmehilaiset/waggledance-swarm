...
"""Verify a route-stage handoff-bundle verifier-summary bridge-template index-entry index entry."""
...
from tools.build_route_stage_handoff_verifier_summary_bridge_template_index_entry import (  # noqa: E402
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.json or report["ok"]:
        ...
        print(
            "route-stage handoff-bundle verifier-summary bridge-template index entry "
            "verification FAILED: "
...
def verify_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry(
    *,
...
def _assert_no_forbidden_output(text: str) -> None:
    if _forbidden_output_markers(text):
        raise ValueError(
            "route-stage handoff-bundle verifier-summary bridge-event template index entry "
