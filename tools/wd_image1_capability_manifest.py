...
from tools.verify_runtime_gap_scheduler_candidate_bridge_event_template_index_entry import (  # noqa: E402
...
def build_hex_mesh_route_stage_runtime_metrics_smoke(
    ...
    required_paths = (
        ...
        "tools/verify_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry.py",
        "tests/tools/test_verify_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry.py",
        "tools/build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary.py",
    ...
    drill_template_tests_text = (
        repo_root
        / "tests/tools/test_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template.py"
    ).read_text(encoding="utf-8")
    drill_template_index_entry_text = (
        repo_root
        / "tools/build_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry.py"
    ).read_text(encoding="utf-8")
    drill_template_index_entry_tests_text = (
        repo_root
        / "tests/tools/test_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry.py"
    ).read_text(encoding="utf-8")
    drill_template_index_entry_verifier_text = (
        repo_root
        / "tools/verify_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry.py"
    ).read_text(encoding="utf-8")
    drill_template_index_entry_verifier_tests_text = (
        repo_root
        / "tests/tools/test_verify_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry.py"
    ).read_text(encoding="utf-8")
    drill_template_index_entry_verifier_summary_text = (
        repo_root
        / "tools/build_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry_verification_summary.py"
    ).read_text(encoding="utf-8")
    ...
    drill_template_index_entry_verifier_summary_template_index_entry_verifier_text = (
        repo_root
        / "tools/verify_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry.py"
    ).read_text(encoding="utf-8")
    drill_template_index_entry_verifier_summary_template_index_entry_verifier_tests_text = (
        repo_root
        / "tests/tools/test_verify_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_summary_text = (
        repo_root
        / "tools/build_route_stage_feed_health_drill_evidence_reviewer_handoff_summary.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_summary_tests_text = (
        repo_root
        / "tests/tools/test_route_stage_feed_health_drill_evidence_reviewer_handoff_summary.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_bundle_index_text = (
        repo_root
        / "tools/build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_index.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_bundle_index_tests_text = (
        repo_root
        / "tests/tools/test_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_index.py"
    ).read_text(encoding="utf-8")
    ...
    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_text = (
        repo_root
        / "tools/build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_tests_text = (
        repo_root
        / "tests/tools/test_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_verifier_text = (
        repo_root
        / "tools/verify_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_verifier_tests_text = (
        repo_root
        / "tests/tools/test_verify_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_text = (
        repo_root
        / "tools/build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary.py"
    ).read_text(encoding="utf-8")
    ...
    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_text = (
        repo_root
        / "tools/build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_tests_text = (
        repo_root
        / "tests/tools/test_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verifier_text = (
        repo_root
        / "tools/verify_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verifier_tests_text = (
        repo_root
        / "tests/tools/test_verify_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_text = (
        repo_root
        / "tools/build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_tests_text = (
        repo_root
        / "tests/tools/test_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_text = (
        repo_root
        / "tools/build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_tests_text = (
        repo_root
        / "tests/tools/test_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry_text = (
        repo_root
        / "tools/build_route_stage_handoff_verifier_summary_bridge_template_index_entry.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry_tests_text = (
        repo_root
        / "tests/tools/test_route_stage_handoff_verifier_summary_bridge_template_index_entry.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry_verifier_text = (
        repo_root
        / "tools/verify_route_stage_handoff_verifier_summary_bridge_template_index_entry.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry_verifier_tests_text = (
        repo_root
        / "tests/tools/test_verify_route_stage_handoff_verifier_summary_bridge_template_index_entry.py"
    ).read_text(encoding="utf-8")
    docs_text = (repo_root / "docs/API.md").read_text(encoding="utf-8")
    ...
    checks = {
        ...
        "ops_latency_feed_slo_drill_contract_present": all(
            ...
            for token in (
                ...
                "test_ops_route_stage_latency_feed_slo_drill_evidence_tracks_health",
        ...
        "ops_latency_feed_drill_evidence_verification_summary_bridge_event_template_present": all(
            ...
            for token in (
                ...
                "test_route_stage_feed_health_verification_summary_bridge_event_template_validates_schema",
            )
        )
        and (
        ...
        "ops_latency_feed_drill_evidence_verification_summary_bridge_event_template_index_entry_present": all(
            token
            in "\n".join(
                (
                    drill_template_index_entry_text,
            ...
            for token in (
                ...
                "artifact_payloads_included",
                "local_paths_recorded",
                "test_route_stage_feed_health_verification_summary_bridge_event_template_index_entry_ties_digests_without_authority",
            )
        )
        and (
            drill_verifier_smoke.get(
        ...
        "ops_latency_feed_drill_evidence_verification_summary_bridge_event_template_index_entry_verifier_present": all(
            token
            in "\n".join(
                (
                    drill_template_index_entry_verifier_text,
            ...
            for token in (
                ...
                "network_access_performed",
                "test_route_stage_feed_health_verification_summary_bridge_event_template_index_entry_verifier_recomputes_digests_without_authority",
            )
        )
        and (
            drill_verifier_smoke.get(
        ...
        "ops_latency_feed_drill_evidence_verification_summary_bridge_event_template_index_entry_verification_summary_present": all(
            token
            in "\n".join(
                (
                    drill_template_index_entry_verifier_summary_text,
            ...
            for token in (
                "SUMMARY_VERSION",
                "bridge_event_template_index_entry_verification_summary.v1",
                ...
                "artifact_payloads_included",
                "local_paths_recorded",
                "test_route_stage_feed_health_index_entry_verification_summary_renders_without_authority",
            )
        )
        and (
            drill_verifier_smoke.get(
        ...
        "ops_latency_feed_drill_evidence_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verifier_present": all(
            token
            in "\n".join(
                (
                    drill_template_index_entry_verifier_summary_template_index_entry_verifier_text,
            ...
            for token in (
                ...
                "bridge_event_schema_check",
                "artifact_payloads_included",
                "test_route_stage_verifier_summary_template_index_entry_verifier_recomputes_without_authority",
            )
        )
        and (
            drill_verifier_smoke.get(
        ...
        "ops_latency_feed_drill_evidence_reviewer_handoff_summary_present": all(
            token
            in "\n".join(
                (
                    drill_reviewer_handoff_summary_text,
            ...
            for token in (
                "SUMMARY_VERSION",
                "route_stage_feed_health_drill_evidence_reviewer_handoff_summary.v1",
                "build_route_stage_feed_health_drill_evidence_reviewer_handoff_summary",
                "validated_verifier_chain",
                "direct_bridge_write_performed",
                "artifact_payloads_included",
                "test_route_stage_feed_health_reviewer_handoff_summary_renders_final_verifier_without_authority",
            )
        )
        and (
            drill_verifier_smoke.get("reviewer_handoff_summary_smoke", {}).get(
                "ok"
            )
            is True
        ),
        "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_index_present": all(
            token
            in "\n".join(
                (
                    drill_reviewer_handoff_bundle_index_text,
            ...
            for token in (
                ...
                "route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_index.v1",
                "build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_index",
                "handoff_bundle",
                "source_contract_check",
                "rebuilt_summary_check",
                "artifact_payloads_included",
                "test_route_stage_reviewer_handoff_bundle_index_ties_artifacts_without_authority",
            )
        )
        and (
            drill_verifier_smoke.get("reviewer_handoff_bundle_index_smoke", {}).get(
                "ok"
            )
            is True
        ),
        "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_index_verifier_present": all(
            token
            in "\n".join(
                (
                    drill_reviewer_handoff_bundle_index_verifier_text,
            ...
            for token in (
                ...
                "artifact_payloads_included",
                "test_route_stage_reviewer_handoff_bundle_index_verifier_recomputes_digests",
            )
        )
        and (
            drill_verifier_smoke.get(
        ...
        "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_present": all(
            token
            in "\n".join(
                (
                    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_text,
            ...
            for token in (
                "INDEX_ENTRY_VERSION",
                "handoff_bundle_verification_summary_bridge_event_template_index_entry.v1",
                ...
                "artifact_payloads_included",
                "local_paths_recorded",
                "test_route_stage_handoff_bundle_verification_summary_template_index_entry_ties_digests_without_authority",
            )
        )
        and (
            drill_verifier_smoke.get(
                "reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_smoke",
                {},
            ).get("ok")
            is True
        ),
        "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verifier_present": all(
            token
            in "\n".join(
                (
                    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_verifier_text,
            ...
            for token in (
                ...
                "bridge_event_schema_check",
                "artifact_payloads_included",
                "test_route_stage_handoff_bundle_summary_template_index_entry_verifier_recomputes_without_authority",
            )
        )
        and (
            drill_verifier_smoke.get(
                "reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_smoke",
                {},
            ).get("ok")
            is True
        ),
        "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_present": all(
            token
            in "\n".join(
                (
                    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_text,
            ...
            for token in (
                ...
                "render_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_markdown",
                "source_contract_check",
                "rebuilt_index_entry_check",
                "artifact_payloads_included",
                "test_route_stage_handoff_bundle_template_index_entry_verification_summary_renders_without_authority",
            )
        )
        and (
            drill_verifier_smoke.get(
        ...
        "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_present": all(
            token
            in "\n".join(
                (
                    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_text,
            ...
            for token in (
                ...
                "rebuilt_template_check",
                "artifact_payloads_included",
                "test_route_stage_handoff_bundle_verifier_summary_bridge_event_template_index_entry_ties_digests_without_authority",
            )
        )
        and (
            drill_verifier_smoke.get(
                "reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_smoke",
                {},
            ).get("ok")
            is True
        ),
        "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verifier_present": all(
            token
            in "\n".join(
                (
                    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verifier_text,
            ...
            for token in (
                ...
                "bridge_event_schema_check",
                "artifact_payloads_included",
                "test_route_stage_handoff_bundle_verifier_summary_template_index_entry_verifier_recomputes_without_authority",
            )
        )
        and (
            drill_verifier_smoke.get(
                "reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_smoke",
                {},
            ).get("ok")
            is True
        ),
        "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_present": all(
            token
            in "\n".join(
                (
                    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_text,
        ...
        and (
            drill_verifier_smoke.get(
                "reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_smoke",
                {},
            ).get("ok")
            is True
        ),
        "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_present": all(
            token
            in "\n".join(
                (
                    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_text,
        ...
        and (
            drill_verifier_smoke.get(
                "reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_smoke",
                {},
            ).get("ok")
            is True
        ),
        "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_present": all(
            token
            in "\n".join(
                (
                    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry_text,
            ...
            for token in (
                ...
                "build_route_stage_handoff_verifier_summary_bridge_template_index_entry.py",
                "artifact_payloads_included",
                "test_route_stage_handoff_bundle_verifier_summary_bridge_event_template_index_entry_ties_digests_without_authority",
            )
        )
        ...
        "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_present": all(
            token
            in "\n".join(
                (
                    drill_reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry_verifier_text,
    ...
    return {
        **base,
        ...
        "latency_feed_drill_evidence_verification_summary_bridge_event_template_supported": checks[
            "ops_latency_feed_drill_evidence_verification_summary_bridge_event_template_present"
        ],
        "latency_feed_drill_evidence_verification_summary_bridge_event_template_index_entry_supported": checks[
            "ops_latency_feed_drill_evidence_verification_summary_bridge_event_template_index_entry_present"
        ],
        "latency_feed_drill_evidence_verification_summary_bridge_event_template_index_entry_verifier_supported": checks[
            "ops_latency_feed_drill_evidence_verification_summary_bridge_event_template_index_entry_verifier_present"
        ],
        ...
        "latency_feed_drill_evidence_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verifier_supported": checks[
            "ops_latency_feed_drill_evidence_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verifier_present"
        ],
        "latency_feed_drill_evidence_reviewer_handoff_summary_supported": checks[
            "ops_latency_feed_drill_evidence_reviewer_handoff_summary_present"
        ],
        "latency_feed_drill_evidence_reviewer_handoff_bundle_index_supported": checks[
            "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_index_present"
        ],
        ...
        "latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_supported": checks[
            "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_present"
        ],
        "latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verifier_supported": checks[
            "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verifier_present"
        ],
        ...
        "latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_supported": checks[
            "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_present"
        ],
        "latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verifier_supported": checks[
            "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verifier_present"
        ],
        "latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_supported": checks[
            "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_present"
        ],
        "latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_supported": checks[
            "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_present"
        ],
        "latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_supported": checks[
            "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_present"
        ],
        "latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_supported": checks[
            "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_present"
        ],
        ...
        "safe_conclusion": (
            ...
            "and a local index entry plus verifier for that renderer and "
            "path-free verification summary renderer for that verifier "
            "plus a template-only bridge-event renderer for that verifier "
            "verification summary and a local index entry for that renderer "
...
def _build_route_stage_feed_health_drill_evidence_verifier_smoke() -> dict:
    try:
        ...
        from tools.build_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template import (
            TEMPLATE_VERSION as DRILL_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_VERSION,
            build_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template,
        )
        from tools.build_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry import (
            INDEX_ENTRY_VERSION as DRILL_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERSION,
            build_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry,
        )
        from tools.verify_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry import (
            VERIFICATION_VERSION as DRILL_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_VERSION,
            verify_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry,
        )
        ...
        from tools.verify_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry import (
            VERIFICATION_VERSION as DRILL_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_VERSION,
            verify_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry,
        )
        from tools.build_route_stage_feed_health_drill_evidence_reviewer_handoff_summary import (
            SUMMARY_VERSION as DRILL_REVIEWER_HANDOFF_SUMMARY_VERSION,
            build_route_stage_feed_health_drill_evidence_reviewer_handoff_summary,
        )
        from tools.build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_index import (
            BUNDLE_INDEX_VERSION as DRILL_REVIEWER_HANDOFF_BUNDLE_INDEX_VERSION,
            build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_index,
        )
        ...
        from tools.build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry import (
            INDEX_ENTRY_VERSION as DRILL_REVIEWER_HANDOFF_BUNDLE_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERSION,
            build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry,
        )
        from tools.verify_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry import (
            VERIFICATION_VERSION as DRILL_REVIEWER_HANDOFF_BUNDLE_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_VERSION,
            verify_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry,
        )
        ...
        from tools.build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry import (
            INDEX_ENTRY_VERSION as DRILL_REVIEWER_HANDOFF_BUNDLE_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERSION,
            build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry,
        )
        from tools.verify_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry import (
            VERIFICATION_VERSION as DRILL_REVIEWER_HANDOFF_BUNDLE_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_VERSION,
            verify_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry,
        )
        from tools.build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary import (
            SUMMARY_VERSION as DRILL_REVIEWER_HANDOFF_BUNDLE_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_VERSION,
            build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary,
        )
        from tools.build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template import (
            TEMPLATE_VERSION as DRILL_REVIEWER_HANDOFF_BUNDLE_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_VERSION,
            build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template,
        )
        from tools.build_route_stage_handoff_verifier_summary_bridge_template_index_entry import (
            INDEX_ENTRY_VERSION as DRILL_REVIEWER_HANDOFF_BUNDLE_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERSION,
            build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry,
        )
        from tools.verify_route_stage_handoff_verifier_summary_bridge_template_index_entry import (
            VERIFICATION_VERSION as DRILL_REVIEWER_HANDOFF_BUNDLE_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_VERSION,
            verify_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry,
        )
        ...
        return {
            ...
            "verification_summary_bridge_event_template_smoke": {
                "ok": False,
                "blocked_reason": f"template_import_failed:{exc.__class__.__name__}",
            ...
            "verification_summary_bridge_event_template_index_entry_smoke": {
                "ok": False,
                "blocked_reason": f"index_entry_import_failed:{exc.__class__.__name__}",
                "index_entry_version": None,
                "direct_bridge_write_performed": False,
            },
            "verification_summary_bridge_event_template_index_entry_verification_smoke": {
                "ok": False,
                "blocked_reason": f"index_entry_verification_import_failed:{exc.__class__.__name__}",
            ...
            "verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_smoke": {
                "ok": False,
                "blocked_reason": f"index_entry_verification_summary_bridge_event_template_index_entry_verification_import_failed:{exc.__class__.__name__}",
                "verification_version": None,
                "direct_bridge_write_performed": False,
            },
            "reviewer_handoff_summary_smoke": {
                "ok": False,
                "blocked_reason": f"reviewer_handoff_summary_import_failed:{exc.__class__.__name__}",
                "summary_version": None,
                "direct_bridge_write_performed": False,
            },
            "reviewer_handoff_bundle_index_smoke": {
                "ok": False,
                "blocked_reason": f"reviewer_handoff_bundle_index_import_failed:{exc.__class__.__name__}",
                "bundle_index_version": None,
                "direct_bridge_write_performed": False,
            },
            "reviewer_handoff_bundle_index_verification_smoke": {
                "ok": False,
            ...
            "reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_smoke": {
                "ok": False,
                "blocked_reason": f"reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_import_failed:{exc.__class__.__name__}",
                "index_entry_version": None,
                "direct_bridge_write_performed": False,
            },
            "reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_smoke": {
                "ok": False,
                "blocked_reason": f"reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_import_failed:{exc.__class__.__name__}",
                "verification_version": None,
                "direct_bridge_write_performed": False,
            },
            "reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_smoke": {
            ...
            "reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_smoke": {
                "ok": False,
                "blocked_reason": f"reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_import_failed:{exc.__class__.__name__}",
                "index_entry_version": None,
                "direct_bridge_write_performed": False,
            },
            "reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_smoke": {
                "ok": False,
                "blocked_reason": f"reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_import_failed:{exc.__class__.__name__}",
                "verification_version": None,
                "direct_bridge_write_performed": False,
            },
            "reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_smoke": {
                "ok": False,
                "blocked_reason": f"reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_import_failed:{exc.__class__.__name__}",
                "summary_version": None,
                "direct_bridge_write_performed": False,
            },
            "reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_smoke": {
                "ok": False,
                "blocked_reason": f"reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_import_failed:{exc.__class__.__name__}",
                "template_version": None,
                "direct_bridge_write_performed": False,
            },
            "reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_smoke": {
                "ok": False,
                "blocked_reason": f"reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_import_failed:{exc.__class__.__name__}",
                "index_entry_version": None,
                "direct_bridge_write_performed": False,
            },
            "reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_smoke": {
                "ok": False,
                "blocked_reason": f"reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_import_failed:{exc.__class__.__name__}",
                "verification_version": None,
                "direct_bridge_write_performed": False,
            },
    ...
    verification_summary = {
        **valid_report,
        ...
        "evidence_size_bytes": len(package_bytes),
    }
    template_report = build_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template(
    ...
    template_index_entry = build_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry(
        verification_summary=verification_summary,
        bridge_event_template_report=template_report,
        verification_summary_bytes=verification_summary_bytes,
        bridge_event_template_bytes=template_report_bytes,
    )
    template_index_entry_verification = verify_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry(
        index_entry=template_index_entry,
        verification_summary=verification_summary,
        bridge_event_template_report=template_report,
        verification_summary_bytes=verification_summary_bytes,
        bridge_event_template_bytes=template_report_bytes,
    )
    template_index_entry_verification_summary = build_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry_verification_summary(
    ...
    template_index_entry_verification_summary_template_index_entry_verification = verify_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry(
        index_entry=template_index_entry_verification_summary_template_index_entry,
    ...
    reviewer_handoff_summary = build_route_stage_feed_health_drill_evidence_reviewer_handoff_summary(
        verification_report=(
            template_index_entry_verification_summary_template_index_entry_verification
        ),
        reviewer_agent_id="claude-rco-1",
        handoff_ref="bridge:handoff:route-stage-feed-health-drill-reviewer-handoff",
    )
    final_verification_bytes = json.dumps(
        template_index_entry_verification_summary_template_index_entry_verification,
        ensure_ascii=True,
        separators=(",", ":"),
        sort_keys=True,
    ).encode("utf-8")
    reviewer_handoff_summary_bytes = json.dumps(
        reviewer_handoff_summary,
        ensure_ascii=True,
        separators=(",", ":"),
        sort_keys=True,
    ).encode("utf-8")
    reviewer_handoff_bundle_index = build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_index(
        verification_report=(
            template_index_entry_verification_summary_template_index_entry_verification
        ),
    ...
    reviewer_handoff_bundle_index_verification = verify_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_index(
        bundle_index=reviewer_handoff_bundle_index,
        verification_report=(
            template_index_entry_verification_summary_template_index_entry_verification
        ),
        reviewer_handoff_summary=reviewer_handoff_summary,
    ...
    reviewer_handoff_bundle_verification_summary_bytes = json.dumps(
        reviewer_handoff_bundle_verification_summary,
        ensure_ascii=True,
        separators=(",", ":"),
        sort_keys=True,
    ).encode("utf-8")
    reviewer_handoff_bundle_verification_summary_template_bytes = json.dumps(
        reviewer_handoff_bundle_verification_summary_template,
        ensure_ascii=True,
        separators=(",", ":"),
        sort_keys=True,
    ).encode("utf-8")
    reviewer_handoff_bundle_verification_summary_template_index_entry = build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry(
        bundle_verification_summary=reviewer_handoff_bundle_verification_summary,
        summary_bridge_event_template_report=(
            reviewer_handoff_bundle_verification_summary_template
        ),
        bundle_verification_summary_bytes=(
            reviewer_handoff_bundle_verification_summary_bytes
        ),
        summary_bridge_event_template_bytes=(
            reviewer_handoff_bundle_verification_summary_template_bytes
        ),
    )
    reviewer_handoff_bundle_verification_summary_template_index_entry_verification = verify_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry(
        index_entry=reviewer_handoff_bundle_verification_summary_template_index_entry,
        bundle_verification_summary=reviewer_handoff_bundle_verification_summary,
        summary_bridge_event_template_report=(
            reviewer_handoff_bundle_verification_summary_template
        ),
    ...
    reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary = build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary(
        verification_report=(
            reviewer_handoff_bundle_verification_summary_template_index_entry_verification
        ),
        reviewer_agent_id="claude-rco-1",
        handoff_ref=(
    ...
    template_smoke = {
        "ok": (
            template_report.get("ok") is True
            and template_report.get("template_version")
            == DRILL_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_VERSION
            and isinstance(template_event, dict)
            and template_event.get("cwd") == "template_not_emitted"
            and template_event.get("paths") == []
            and template_event.get("write_scope") == []
            and template_payload.get("template_only") is True
            and template_boundary.get("manual_review_required") is True
            and template_boundary.get("direct_bridge_write_performed") is False
            and template_boundary.get("runtime_controls_added") is False
            and template_boundary.get("artifact_payloads_included") is False
            and template_boundary.get("local_paths_recorded") is False
            and template_boundary.get("network_access_performed") is False
        ),
        "template_version": template_report.get("template_version"),
        "template_only": template_report.get("template_only"),
        "manual_review_required": template_report.get("manual_review_required"),
    ...
    template_index_entry_record = template_index_entry.get("template_index_entry", {})
    template_index_entry_boundary = template_index_entry.get("operator_boundary", {})
    template_index_entry_smoke = {
        "ok": (
            template_index_entry.get("ok") is True
            and template_index_entry.get("index_entry_version")
            == DRILL_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERSION
            and template_index_entry_record.get("template_only") is True
            and template_index_entry_record.get("source_contract_check") == "match"
            and template_index_entry_record.get("rebuilt_template_check") == "match"
            and template_index_entry_record.get("direct_bridge_write_performed")
            is False
            and template_index_entry_record.get("artifact_payloads_included") is False
            and template_index_entry_record.get("local_paths_recorded") is False
            and template_index_entry_boundary.get("manual_review_required") is True
            and template_index_entry_boundary.get("runtime_controls_added") is False
            and template_index_entry_boundary.get("network_access_performed") is False
        ),
        "index_entry_version": template_index_entry.get("index_entry_version"),
        "template_only": template_index_entry.get("template_only"),
        "manual_review_required": template_index_entry.get("manual_review_required"),
        "source_contract_check": template_index_entry_record.get(
            "source_contract_check"
        ),
        "rebuilt_template_check": template_index_entry_record.get(
            "rebuilt_template_check"
        ),
        "direct_bridge_write_performed": template_index_entry.get(
            "direct_bridge_write_performed"
        ),
        "artifact_payloads_included": template_index_entry.get(
            "artifact_payloads_included"
        ),
        "local_paths_recorded": template_index_entry.get("local_paths_recorded"),
        "network_access_performed": template_index_entry.get(
            "network_access_performed"
        ),
        "blockers": template_index_entry.get("blockers", []),
    }
    template_index_entry_verification_smoke = {
        "ok": (
            template_index_entry_verification.get("ok") is True
            and template_index_entry_verification.get("verification_version")
            == DRILL_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_VERSION
            and template_index_entry_verification.get("source_contract_check")
            == "match"
            and template_index_entry_verification.get("rebuilt_index_entry_check")
            == "match"
            and template_index_entry_verification.get("bridge_event_schema_check")
            == "match"
            and set(template_index_entry_verification.get("digest_checks", {}).values())
            == {"match"}
            and template_index_entry_verification.get("direct_bridge_write_performed")
            is False
            and template_index_entry_verification.get("artifact_payloads_included")
            is False
            and template_index_entry_verification.get("local_paths_recorded")
            is False
            and template_index_entry_verification.get("network_access_performed")
            is False
        ),
        "verification_version": template_index_entry_verification.get(
            "verification_version"
        ),
        "source_contract_check": template_index_entry_verification.get(
            "source_contract_check"
        ),
        "rebuilt_index_entry_check": template_index_entry_verification.get(
            "rebuilt_index_entry_check"
        ),
        "bridge_event_schema_check": template_index_entry_verification.get(
            "bridge_event_schema_check"
        ),
        "digest_checks": template_index_entry_verification.get("digest_checks", {}),
        "direct_bridge_write_performed": template_index_entry_verification.get(
            "direct_bridge_write_performed"
        ),
        "artifact_payloads_included": template_index_entry_verification.get(
            "artifact_payloads_included"
        ),
        "local_paths_recorded": template_index_entry_verification.get(
            "local_paths_recorded"
        ),
        "network_access_performed": template_index_entry_verification.get(
            "network_access_performed"
        ),
        "blockers": template_index_entry_verification.get("blockers", []),
    }
    template_index_entry_verification_summary_payload = (
        template_index_entry_verification_summary.get(
            "route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry_verification",
            {},
        )
    )
    template_index_entry_verification_summary_boundary = (
        template_index_entry_verification_summary.get("operator_boundary", {})
    )
    template_index_entry_verification_summary_smoke = {
        "ok": (
            template_index_entry_verification_summary.get("ok") is True
            and template_index_entry_verification_summary.get("summary_version")
            == DRILL_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_VERSION
            and template_index_entry_verification_summary_payload.get(
                "verification_ok"
            )
            is True
            and template_index_entry_verification_summary_payload.get(
            ...
            == "match"
            and template_index_entry_verification_summary_boundary.get(
                "verification_report_boundary_ok"
            )
            is True
            and template_index_entry_verification_summary.get(
                "direct_bridge_write_performed"
            )
            is False
            and template_index_entry_verification_summary.get("transport_added")
            is False
            and template_index_entry_verification_summary.get(
                "artifact_payloads_included"
            )
            is False
            and template_index_entry_verification_summary.get("local_paths_recorded")
            is False
            and template_index_entry_verification_summary.get(
        ...
        "summary_version": template_index_entry_verification_summary.get(
            "summary_version"
        ),
        "verification_ok": template_index_entry_verification_summary_payload.get(
            "verification_ok"
        ),
        "source_contract_check": template_index_entry_verification_summary_payload.get(
            "source_contract_check"
        ),
        "rebuilt_index_entry_check": template_index_entry_verification_summary_payload.get(
            "rebuilt_index_entry_check"
        ),
        "bridge_event_schema_check": template_index_entry_verification_summary_payload.get(
            "bridge_event_schema_check"
        ),
        "verification_report_boundary_ok": template_index_entry_verification_summary_boundary.get(
            "verification_report_boundary_ok"
        ),
        "direct_bridge_write_performed": template_index_entry_verification_summary.get(
            "direct_bridge_write_performed"
        ),
        "artifact_payloads_included": template_index_entry_verification_summary.get(
            "artifact_payloads_included"
        ),
        "local_paths_recorded": template_index_entry_verification_summary.get(
            "local_paths_recorded"
        ),
        "network_access_performed": template_index_entry_verification_summary.get(
            "network_access_performed"
        ),
    ...
    template_index_entry_verification_summary_bridge_event_template_index_entry_verification_smoke = {
        "ok": (
            template_index_entry_verification_summary_template_index_entry_verification.get(
                "ok"
            )
            is True
            and template_index_entry_verification_summary_template_index_entry_verification.get(
                "verification_version"
            )
            == DRILL_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_VERSION
            and template_index_entry_verification_summary_template_index_entry_verification.get(
                "source_contract_check"
            )
            == "match"
        ...
        "verification_version": template_index_entry_verification_summary_template_index_entry_verification.get(
            "verification_version"
        ),
        "source_contract_check": template_index_entry_verification_summary_template_index_entry_verification.get(
            "source_contract_check"
        ),
        "rebuilt_index_entry_check": template_index_entry_verification_summary_template_index_entry_verification.get(
            "rebuilt_index_entry_check"
        ),
        "bridge_event_schema_check": template_index_entry_verification_summary_template_index_entry_verification.get(
            "bridge_event_schema_check"
        ),
        "digest_checks": template_index_entry_verification_summary_template_index_entry_verification.get(
            "digest_checks",
            {},
        ),
        "direct_bridge_write_performed": template_index_entry_verification_summary_template_index_entry_verification.get(
            "direct_bridge_write_performed"
        ),
        "artifact_payloads_included": template_index_entry_verification_summary_template_index_entry_verification.get(
            "artifact_payloads_included"
        ),
        "local_paths_recorded": template_index_entry_verification_summary_template_index_entry_verification.get(
            "local_paths_recorded"
        ),
        "network_access_performed": template_index_entry_verification_summary_template_index_entry_verification.get(
            "network_access_performed"
        ),
        "blockers": template_index_entry_verification_summary_template_index_entry_verification.get(
            "blockers",
            [],
        ),
    }
    reviewer_handoff_chain = reviewer_handoff_summary.get(
        "validated_verifier_chain",
        {},
    )
    reviewer_handoff_boundary = reviewer_handoff_summary.get(
        "operator_boundary",
        {},
    )
    reviewer_handoff_summary_smoke = {
        "ok": (
            reviewer_handoff_summary.get("ok") is True
            and reviewer_handoff_summary.get("summary_version")
            == DRILL_REVIEWER_HANDOFF_SUMMARY_VERSION
            and reviewer_handoff_chain.get("verification_ok") is True
            and reviewer_handoff_chain.get("source_contract_check") == "match"
            and reviewer_handoff_chain.get("rebuilt_index_entry_check") == "match"
            and reviewer_handoff_chain.get("bridge_event_schema_check") == "match"
            and reviewer_handoff_boundary.get("verification_report_boundary_ok")
            is True
            and reviewer_handoff_summary.get("manual_review_required") is True
            and reviewer_handoff_summary.get("approval_granted") is False
            and reviewer_handoff_summary.get("direct_bridge_write_performed")
            is False
            and reviewer_handoff_summary.get("transport_added") is False
            and reviewer_handoff_summary.get("artifact_payloads_included") is False
            and reviewer_handoff_summary.get("local_paths_recorded") is False
            and reviewer_handoff_summary.get("network_access_performed") is False
        ),
        "summary_version": reviewer_handoff_summary.get("summary_version"),
        "verification_ok": reviewer_handoff_chain.get("verification_ok"),
        "source_contract_check": reviewer_handoff_chain.get(
            "source_contract_check"
        ),
        "rebuilt_index_entry_check": reviewer_handoff_chain.get(
            "rebuilt_index_entry_check"
        ),
        "bridge_event_schema_check": reviewer_handoff_chain.get(
            "bridge_event_schema_check"
        ),
        "verification_report_boundary_ok": reviewer_handoff_boundary.get(
            "verification_report_boundary_ok"
        ),
        "manual_review_required": reviewer_handoff_summary.get(
            "manual_review_required"
        ),
        "approval_granted": reviewer_handoff_summary.get("approval_granted"),
        "direct_bridge_write_performed": reviewer_handoff_summary.get(
            "direct_bridge_write_performed"
        ),
        "artifact_payloads_included": reviewer_handoff_summary.get(
            "artifact_payloads_included"
        ),
        "local_paths_recorded": reviewer_handoff_summary.get("local_paths_recorded"),
        "network_access_performed": reviewer_handoff_summary.get(
            "network_access_performed"
        ),
        "blockers": reviewer_handoff_summary.get("blockers", []),
    }
    reviewer_handoff_bundle = reviewer_handoff_bundle_index.get(
        "handoff_bundle",
        {},
    )
    reviewer_handoff_bundle_boundary = reviewer_handoff_bundle_index.get(
        "operator_boundary",
        {},
    )
    reviewer_handoff_bundle_index_smoke = {
        "ok": (
            reviewer_handoff_bundle_index.get("ok") is True
            and reviewer_handoff_bundle_index.get("bundle_index_version")
            == DRILL_REVIEWER_HANDOFF_BUNDLE_INDEX_VERSION
            and reviewer_handoff_bundle.get("source_contract_check") == "match"
            and reviewer_handoff_bundle.get("rebuilt_summary_check") == "match"
            and reviewer_handoff_bundle_index.get("artifact_count") == 2
            and reviewer_handoff_bundle.get("manual_review_required") is True
            and reviewer_handoff_bundle.get("approval_granted") is False
            and reviewer_handoff_bundle.get("runtime_authority_granted") is False
            and reviewer_handoff_bundle_boundary.get("manual_review_required")
            is True
            and reviewer_handoff_bundle_boundary.get("runtime_authority_granted")
            is False
            and reviewer_handoff_bundle_index.get("direct_bridge_write_performed")
            is False
            and reviewer_handoff_bundle_index.get("artifact_payloads_included")
            is False
            and reviewer_handoff_bundle_index.get("local_paths_recorded") is False
            and reviewer_handoff_bundle_index.get("network_access_performed")
            is False
        ),
        "bundle_index_version": reviewer_handoff_bundle_index.get(
            "bundle_index_version"
        ),
        "artifact_count": reviewer_handoff_bundle_index.get("artifact_count"),
        "source_contract_check": reviewer_handoff_bundle.get(
            "source_contract_check"
        ),
        "rebuilt_summary_check": reviewer_handoff_bundle.get(
            "rebuilt_summary_check"
        ),
        "direct_bridge_write_performed": reviewer_handoff_bundle_index.get(
            "direct_bridge_write_performed"
        ),
        "artifact_payloads_included": reviewer_handoff_bundle_index.get(
            "artifact_payloads_included"
        ),
        "local_paths_recorded": reviewer_handoff_bundle_index.get(
            "local_paths_recorded"
        ),
        "network_access_performed": reviewer_handoff_bundle_index.get(
            "network_access_performed"
        ),
        "blockers": reviewer_handoff_bundle_index.get("blockers", []),
    }
    reviewer_handoff_bundle_index_verification_smoke = {
        "ok": (
            reviewer_handoff_bundle_index_verification.get("ok") is True
            and reviewer_handoff_bundle_index_verification.get("verification_version")
            == DRILL_REVIEWER_HANDOFF_BUNDLE_INDEX_VERIFICATION_VERSION
            and reviewer_handoff_bundle_index_verification.get(
                "source_contract_check"
            )
            == "match"
            and reviewer_handoff_bundle_index_verification.get(
            ...
            == "match"
            and set(
                reviewer_handoff_bundle_index_verification.get(
                    "digest_checks",
                    {},
                ).values()
            )
            ...
            is False
            and reviewer_handoff_bundle_index_verification.get("local_paths_recorded")
            is False
            and reviewer_handoff_bundle_index_verification.get(
                "network_access_performed"
            )
        ...
        "verification_version": reviewer_handoff_bundle_index_verification.get(
            "verification_version"
        ),
        "source_contract_check": reviewer_handoff_bundle_index_verification.get(
            "source_contract_check"
        ),
        "rebuilt_bundle_index_check": reviewer_handoff_bundle_index_verification.get(
            "rebuilt_bundle_index_check"
        ),
        "reviewer_handoff_summary_check": reviewer_handoff_bundle_index_verification.get(
            "reviewer_handoff_summary_check"
        ),
        "digest_checks": reviewer_handoff_bundle_index_verification.get(
            "digest_checks",
            {},
        ),
        "direct_bridge_write_performed": reviewer_handoff_bundle_index_verification.get(
            "direct_bridge_write_performed"
        ),
        "artifact_payloads_included": reviewer_handoff_bundle_index_verification.get(
            "artifact_payloads_included"
        ),
        "local_paths_recorded": reviewer_handoff_bundle_index_verification.get(
            "local_paths_recorded"
        ),
        "network_access_performed": reviewer_handoff_bundle_index_verification.get(
            "network_access_performed"
        ),
    ...
    reviewer_handoff_bundle_verification_summary_template_index = (
        reviewer_handoff_bundle_verification_summary_template_index_entry.get(
            "template_index_entry",
            {},
        )
    )
    reviewer_handoff_bundle_verification_summary_template_index_boundary = (
        reviewer_handoff_bundle_verification_summary_template_index_entry.get(
            "operator_boundary",
            {},
        )
    ...
    reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_smoke = {
        "ok": (
            ...
            is True
            and reviewer_handoff_bundle_verification_summary_template_index_entry.get(
                "index_entry_version"
            )
            == DRILL_REVIEWER_HANDOFF_BUNDLE_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERSION
            and reviewer_handoff_bundle_verification_summary_template_index.get(
                "template_only"
            )
            is True
            and reviewer_handoff_bundle_verification_summary_template_index.get(
            ...
            is False
            and reviewer_handoff_bundle_verification_summary_template_index_boundary.get(
                "manual_review_required"
            )
            is True
            and reviewer_handoff_bundle_verification_summary_template_index_boundary.get(
        ...
        "index_entry_version": reviewer_handoff_bundle_verification_summary_template_index_entry.get(
            "index_entry_version"
        ),
        "template_only": reviewer_handoff_bundle_verification_summary_template_index_entry.get(
            "template_only"
        ),
        "manual_review_required": reviewer_handoff_bundle_verification_summary_template_index_entry.get(
            "manual_review_required"
        ),
        "source_contract_check": reviewer_handoff_bundle_verification_summary_template_index.get(
            "source_contract_check"
        ),
        "rebuilt_template_check": reviewer_handoff_bundle_verification_summary_template_index.get(
            "rebuilt_template_check"
        ),
        "direct_bridge_write_performed": reviewer_handoff_bundle_verification_summary_template_index_entry.get(
            "direct_bridge_write_performed"
        ),
        "artifact_payloads_included": reviewer_handoff_bundle_verification_summary_template_index_entry.get(
            "artifact_payloads_included"
        ),
        "local_paths_recorded": reviewer_handoff_bundle_verification_summary_template_index_entry.get(
            "local_paths_recorded"
        ),
        "network_access_performed": reviewer_handoff_bundle_verification_summary_template_index_entry.get(
            "network_access_performed"
        ),
        "blockers": reviewer_handoff_bundle_verification_summary_template_index_entry.get(
            "blockers",
            [],
        ),
    }
    reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_smoke = {
        "ok": (
            reviewer_handoff_bundle_verification_summary_template_index_entry_verification.get(
                "ok"
            )
            is True
            and reviewer_handoff_bundle_verification_summary_template_index_entry_verification.get(
                "verification_version"
            )
            == DRILL_REVIEWER_HANDOFF_BUNDLE_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_VERSION
            and reviewer_handoff_bundle_verification_summary_template_index_entry_verification.get(
                "source_contract_check"
            )
            == "match"
        ...
        "verification_version": reviewer_handoff_bundle_verification_summary_template_index_entry_verification.get(
            "verification_version"
        ),
        "source_contract_check": reviewer_handoff_bundle_verification_summary_template_index_entry_verification.get(
            "source_contract_check"
        ),
        "rebuilt_index_entry_check": reviewer_handoff_bundle_verification_summary_template_index_entry_verification.get(
            "rebuilt_index_entry_check"
        ),
        "bridge_event_schema_check": reviewer_handoff_bundle_verification_summary_template_index_entry_verification.get(
            "bridge_event_schema_check"
        ),
        "digest_checks": reviewer_handoff_bundle_verification_summary_template_index_entry_verification.get(
            "digest_checks",
            {},
        ),
        "direct_bridge_write_performed": reviewer_handoff_bundle_verification_summary_template_index_entry_verification.get(
            "direct_bridge_write_performed"
        ),
        "artifact_payloads_included": reviewer_handoff_bundle_verification_summary_template_index_entry_verification.get(
            "artifact_payloads_included"
        ),
        "local_paths_recorded": reviewer_handoff_bundle_verification_summary_template_index_entry_verification.get(
            "local_paths_recorded"
        ),
        "network_access_performed": reviewer_handoff_bundle_verification_summary_template_index_entry_verification.get(
            "network_access_performed"
        ),
        "blockers": reviewer_handoff_bundle_verification_summary_template_index_entry_verification.get(
            "blockers",
            [],
        ),
    }
    reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_smoke = {
        "ok": (
            reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary.get(
                "ok"
            )
            is True
            and reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary.get(
                "summary_version"
            )
            == DRILL_REVIEWER_HANDOFF_BUNDLE_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_VERSION
            and reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary.get(
                "manual_review_required"
            )
            is True
        ...
        "summary_version": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary.get(
            "summary_version"
        ),
        "template_only": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary.get(
            "template_only"
        ),
        "manual_review_required": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary.get(
            "manual_review_required"
        ),
        "direct_bridge_write_performed": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary.get(
            "direct_bridge_write_performed"
        ),
        "artifact_payloads_included": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary.get(
            "artifact_payloads_included"
        ),
        "local_paths_recorded": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary.get(
            "local_paths_recorded"
        ),
        "network_access_performed": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary.get(
            "network_access_performed"
        ),
        "blockers": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary.get(
            "blockers",
            [],
        ),
    }
    ...
    reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_bytes = json.dumps(
        reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary,
        ensure_ascii=True,
        separators=(",", ":"),
        sort_keys=True,
    ).encode("utf-8")
    reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_bytes = json.dumps(
        reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template,
        ensure_ascii=True,
        separators=(",", ":"),
        sort_keys=True,
    ).encode("utf-8")
    reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry = build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry(
        index_entry_verification_summary=(
            reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary
        ),
        summary_bridge_event_template_report=(
        ...
        index_entry_verification_summary_bytes=(
            reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_bytes
        ),
        summary_bridge_event_template_bytes=(
            reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_bytes
        ),
    )
    reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_smoke = {
        "ok": (
            reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry.get(
                "ok"
            )
            is True
            and reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry.get(
                "index_entry_version"
            )
            == DRILL_REVIEWER_HANDOFF_BUNDLE_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERSION
            and reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry.get(
                "direct_bridge_write_performed"
            )
            is False
        ...
        "index_entry_version": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry.get(
            "index_entry_version"
        ),
        "template_only": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry.get(
            "template_only"
        ),
        "direct_bridge_write_performed": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry.get(
            "direct_bridge_write_performed"
        ),
        "artifact_payloads_included": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry.get(
            "artifact_payloads_included"
        ),
        "local_paths_recorded": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry.get(
            "local_paths_recorded"
        ),
        "network_access_performed": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry.get(
            "network_access_performed"
        ),
        "blockers": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry.get(
            "blockers",
            [],
        ),
    }
    reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification = verify_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry(
        index_entry=(
            reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry
        ),
        index_entry_verification_summary=(
            reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary
        ),
    ...
    reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_smoke = {
        "ok": (
            reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
                "ok"
            )
            is True
            and reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
                "verification_version"
            )
            == DRILL_REVIEWER_HANDOFF_BUNDLE_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_VERSION
            and reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
                "source_contract_check"
            )
            == "match"
        ...
        "verification_version": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
            "verification_version"
        ),
        "source_contract_check": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
            "source_contract_check"
        ),
        "rebuilt_index_entry_check": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
            "rebuilt_index_entry_check"
        ),
        "bridge_event_schema_check": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
            "bridge_event_schema_check"
        ),
        "direct_bridge_write_performed": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
            "direct_bridge_write_performed"
        ),
        "artifact_payloads_included": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
            "artifact_payloads_included"
        ),
        "local_paths_recorded": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
            "local_paths_recorded"
        ),
        "network_access_performed": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
            "network_access_performed"
        ),
        "blockers": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
            "blockers",
            [],
        ),
    }
    reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary = build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary(
        verification_report=(
            reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification
        ),
        reviewer_agent_id="claude-rco-1",
        handoff_ref=(
            "bridge:handoff:route-stage-feed-health-drill-handoff-bundle-template-index-entry-verifier"
        ),
    )
    reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_smoke = {
        "ok": (
            reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary.get(
                "ok"
            )
            is True
            and reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary.get(
                "summary_version"
            )
            == DRILL_REVIEWER_HANDOFF_BUNDLE_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_VERSION
            and reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary.get(
                "direct_bridge_write_performed"
            )
            is False
        ...
        "summary_version": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary.get(
            "summary_version"
        ),
        "template_only": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary.get(
            "template_only"
        ),
        "manual_review_required": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary.get(
            "manual_review_required"
        ),
        "direct_bridge_write_performed": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary.get(
            "direct_bridge_write_performed"
        ),
        "artifact_payloads_included": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary.get(
            "artifact_payloads_included"
        ),
        "local_paths_recorded": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary.get(
            "local_paths_recorded"
        ),
        "network_access_performed": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary.get(
            "network_access_performed"
        ),
        "blockers": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary.get(
            "blockers",
            [],
        ),
    }
    reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template = build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template(
        summary=(
            reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary
        ),
        agent_id="codex-lead-1",
        task_id=(
            "wd-image1-route-stage-handoff-bundle-template-index-verifier-verification-summary"
        ),
        to="operator,claude-rco-1,codex-tools-1",
        role="lead-impl",
    )
    reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_event = (
        reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template.get(
            "bridge_event_template"
        )
    )
    reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_payload = (
        reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_event.get(
            "payload"
        )
        if isinstance(
            reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_event,
    ...
    reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_smoke = {
        "ok": (
            ...
            is True
            and reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template.get(
                "template_version"
            )
            == DRILL_REVIEWER_HANDOFF_BUNDLE_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_VERSION
            and isinstance(
                reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_event,
                dict,
            )
            and reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_event.get(
                "cwd"
            )
            == "template_not_emitted"
            and reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_event.get(
            ...
            == []
            and reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_payload.get(
                "template_only"
            )
            is True
            and reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_payload.get(
        ...
        "template_version": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template.get(
            "template_version"
        ),
        "template_only": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template.get(
            "template_only"
        ),
        "manual_review_required": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template.get(
            "manual_review_required"
        ),
        "direct_bridge_write_performed": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template.get(
            "direct_bridge_write_performed"
        ),
        "artifact_payloads_included": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template.get(
            "artifact_payloads_included"
        ),
        "local_paths_recorded": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template.get(
            "local_paths_recorded"
        ),
        "network_access_performed": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template.get(
            "network_access_performed"
        ),
        "blockers": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template.get(
            "blockers",
            [],
        ),
    }
    reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_bytes = json.dumps(
        reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary,
        ensure_ascii=True,
        separators=(",", ":"),
        sort_keys=True,
    ).encode("utf-8")
    reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_bytes = json.dumps(
        reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template,
        ensure_ascii=True,
        separators=(",", ":"),
        sort_keys=True,
    ).encode("utf-8")
    reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry = build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry(
        index_entry_verification_summary=(
            reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary
        ),
        summary_bridge_event_template_report=(
        ...
        index_entry_verification_summary_bytes=(
            reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_bytes
        ),
        summary_bridge_event_template_bytes=(
            reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_bytes
        ),
    )
    reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_smoke = {
        "ok": (
            reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry.get(
                "ok"
            )
            is True
            and reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry.get(
                "index_entry_version"
            )
            == DRILL_REVIEWER_HANDOFF_BUNDLE_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERSION
            and reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry.get(
                "direct_bridge_write_performed"
            )
            is False
        ...
        "index_entry_version": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry.get(
            "index_entry_version"
        ),
        "template_only": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry.get(
            "template_only"
        ),
        "direct_bridge_write_performed": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry.get(
            "direct_bridge_write_performed"
        ),
        "artifact_payloads_included": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry.get(
            "artifact_payloads_included"
        ),
        "local_paths_recorded": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry.get(
            "local_paths_recorded"
        ),
        "network_access_performed": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry.get(
            "network_access_performed"
        ),
        "blockers": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry.get(
            "blockers",
            [],
        ),
    }
    reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry_verification = verify_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry(
        index_entry=(
            reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry
        ),
        index_entry_verification_summary=(
    ...
    reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_smoke = {
        "ok": (
            reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
                "ok"
            )
            is True
            and reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
                "verification_version"
            )
            == DRILL_REVIEWER_HANDOFF_BUNDLE_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_VERSION
            and reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
                "index_entry_version"
            )
            == DRILL_REVIEWER_HANDOFF_BUNDLE_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERSION
        ...
        "verification_version": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
            "verification_version"
        ),
        "source_contract_check": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
            "source_contract_check"
        ),
        "rebuilt_index_entry_check": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
            "rebuilt_index_entry_check"
        ),
        "bridge_event_schema_check": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
            "bridge_event_schema_check"
        ),
        "digest_checks": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
            "digest_checks",
            {},
        ),
        "size_checks": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
            "size_checks",
            {},
        ),
        "schema_version_checks": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
            "schema_version_checks",
            {},
        ),
        "direct_bridge_write_performed": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
            "direct_bridge_write_performed"
        ),
        "artifact_payloads_included": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
            "artifact_payloads_included"
        ),
        "local_paths_recorded": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
            "local_paths_recorded"
        ),
        "network_access_performed": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
            "network_access_performed"
        ),
        "blockers": reviewer_handoff_bundle_verification_summary_template_index_entry_verification_summary_template_index_entry_verification_summary_template_index_entry_verification.get(
            "blockers",
            [],
        ),
    }
    ...
    return {
        "ok": (
            valid_report.get("ok") is True
            and rejects_authority_forgery
            and template_smoke["ok"] is True
            ...
            is True
            and template_index_entry_verification_summary_bridge_event_template_index_entry_verification_smoke[
                "ok"
            ]
            is True
            ...
            is True
            and reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_smoke[
                "ok"
            ]
            is True
            and reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_smoke[
                "ok"
            ]
            is True
            and reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_smoke[
                "ok"
            ]
            is True
            ...
            is True
            and reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_smoke[
                "ok"
            ]
            is True
            and reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_smoke[
                "ok"
            ]
            is True
            and reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_smoke[
                "ok"
            ]
            is True
            and reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_smoke[
                "ok"
            ]
            is True
            and reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_smoke[
                "ok"
            ]
            is True
            and reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_smoke[
                "ok"
            ]
            is True
        ),
        ...
        "verification_summary_bridge_event_template_smoke": template_smoke,
        "verification_summary_bridge_event_template_index_entry_smoke": (
            template_index_entry_smoke
        ),
        "verification_summary_bridge_event_template_index_entry_verification_smoke": (
        ...
        "reviewer_handoff_summary_smoke": reviewer_handoff_summary_smoke,
...
def _capabilities(root: Path) -> tuple[Capability, ...]:
    hex_evidence = _evidence(
        ...
        (
            ...
            (
                "tools/build_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template.py",
                "Template-only bridge-event renderer for a verified route-stage feed-health drill evidence summary.",
            ),
            (
                "tools/build_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry.py",
                "Local index entry for the route-stage feed-health drill evidence verification summary bridge-event template.",
            ),
            (
                "tools/verify_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry.py",
                "Local verifier for the route-stage feed-health drill evidence verification summary bridge-event template index entry.",
            ),
            (
                "tools/build_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry_verification_summary.py",
            ...
            (
                "tools/verify_route_stage_feed_health_drill_evidence_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry.py",
                "Local verifier for the route-stage feed-health verifier-summary bridge-event template index entry.",
            ),
            (
                "tools/build_route_stage_feed_health_drill_evidence_reviewer_handoff_summary.py",
                "Path-free reviewer handoff summary for the route-stage feed-health verifier chain.",
            ),
            (
                "tools/build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_index.py",
                "Local handoff bundle index tying the route-stage feed-health final verifier report to the reviewer handoff summary.",
            ),
            (
                "tools/verify_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_index.py",
            ...
            (
                "tools/build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry.py",
                "Local index entry for the route-stage feed-health handoff bundle template index-entry verification-summary bridge-event template.",
            ),
            (
                "tools/verify_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry.py",
                "Local verifier for the route-stage feed-health handoff bundle template index-entry verification-summary bridge-event template index entry.",
            ),
            (
                "tools/build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary.py",
                "Path-free reviewer summary renderer for the route-stage feed-health handoff bundle template index-entry verification-summary bridge-event template index-entry verifier.",
            ),
        ),
    )
    ...
    autogrowth_evidence = _evidence(
        ...
        (
            ...
            (
                ...
                "Local verifier for runtime gap scheduler-candidate bridge-event template index entries; recomputes digest, size, schema, source-contract, and no-authority checks.",
            ),
            (
    ...
    hex_upgrade_shadow_replay_verifier_summary_bridge_event_template_bytes = json.dumps(
        hex_upgrade_shadow_replay_verifier_summary_bridge_event_template,
        sort_keys=True,
    ).encode("utf-8")
    ...
    hex_upgrade_shadow_replay_verifier_summary_bridge_event_template_index_entry_verification = verify_shadow_subdivision_replay_verifier_summary_bridge_event_template_index_entry(
    ...
    hex_upgrade_shadow_replay_verifier_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template = build_shadow_subdivision_replay_verifier_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template(
    ...
    hex_upgrade_shadow_replay_verifier_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry = build_shadow_subdivision_replay_verifier_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry(
        hex_upgrade_shadow_replay_verifier_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template,
        template_report_bytes=(
            hex_upgrade_shadow_replay_verifier_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_bytes
        ),
    )
    hex_upgrade_shadow_replay_verifier_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification = verify_shadow_subdivision_replay_verifier_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry(
        hex_upgrade_shadow_replay_verifier_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry,
        hex_upgrade_shadow_replay_verifier_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template,
        template_report_bytes=(
            hex_upgrade_shadow_replay_verifier_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_bytes
        ),
    ...
    # forbidden-vocabulary exclusion list and per-case delivery detail, so store a
    # CURATED content-safe summary (only derived booleans + an int + the fixed version
    # string), never the raw proof. Measurement-only: NOT folded into
    # hex_upgrade_proof["ok"] below and NEVER upgrades any claim.
    from tools.run_ring_messaging_hierarchy_proof import (  # noqa: E402
        build_ring_messaging_hierarchy_proof as _build_ring_messaging_hierarchy_proof,
    )

    _ring_proof = _build_ring_messaging_hierarchy_proof()
    _ring_proof = _ring_proof if isinstance(_ring_proof, dict) else {}
    _rh_hierarchy = _ring_proof.get("hierarchy")
    _rh_hierarchy = _rh_hierarchy if isinstance(_rh_hierarchy, dict) else {}
    _rh_ring = _ring_proof.get("ring_boundary")
    ...
    hex_upgrade_proof["ok"] = bool(
        ...
        is True
        and hex_upgrade_shadow_replay_verifier_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template.get(
            "ok"
        )
        is True
        and hex_upgrade_shadow_replay_verifier_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry.get(
            "ok"
        )
        is True
        and hex_upgrade_shadow_replay_verifier_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification.get(
            "ok"
        )
        is True
    )
    ...
    low_risk_scheduler_candidate_bridge_event_template_index_entry_verification = (
        verify_runtime_gap_scheduler_candidate_bridge_event_template_index_entry(
            index_entry=(
                low_risk_scheduler_candidate_bridge_event_template_index_entry
            ),
    ...
    low_risk_autonomy_proof["ok"] = bool(
        ...
        is True
        and low_risk_scheduler_candidate_bridge_event_template_index_entry_verification.get(
            "ok"
        )
        is True
    )
    ...
    return (
        Capability(
            ...
            "for that verifier verification summary and a local index entry "
            "for that renderer plus a local verifier for that index entry; "
            ...
            next_smallest_pr=(
                ...
                "index entry verifier without including payloads, recording "
                "paths, appending it, or granting runtime authority."
            ),
        ...
        Capability(
            ...
            gaps=(
                ...
                "The runtime gap scheduler-candidate bridge-event template "
                "index-entry verifier recomputes digest, size, schema, "
        ...
        Capability(
            ...
            safe_statement=(
                ...
                "including payloads or granting runtime authority. A local "
                "verifier for that index entry recomputes digest, size, "
                ...
                "no-bridge-write, and no-runtime-authority boundary. A "
                "template-only bridge-event template renderer can turn that "
                "verification summary into schema-valid handoff JSON while "
                "keeping the same no-append, no-transport, no-payload, "
                "no-path, and no-runtime-authority guardrails. A local index "
                "entry binds that verification summary bridge-event template "
                "digest and schema without payload inclusion, local path "
                "recording, transport, bridge writes, runtime controls, or "
                "runtime subdivision authority. A local verifier for that "
                "index entry recomputes digest, size, schema, source-contract, "
