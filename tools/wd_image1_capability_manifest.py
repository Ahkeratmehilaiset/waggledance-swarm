...
def build_magma_handoff_metrics_alertmanager_adapter_smoke(
    ...
    reviewer_handoff_bundle_operator_decision_reference_review_bundle_verification_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_contract_present = all(
        ...
        for token in (
            ...
            "local operator decision-reference review verifier-summary bridge-event template index entry",
        )
    )
    ...
    return (
        ...
        Capability(
            ...
            safe_statement=(
                ...
                "false. A local operator decision-reference review "
                "verifier-summary bridge-event template index entry can "
                "bind the summary/template digests without payload "
                "inclusion, path recording, transport, bridge writes, "
                "or approval automation while keeping release decisions "
                "false; "
            ...
            next_smallest_pr=(
                ...
                "review verifier-summary bridge-event template local index "
                "entry without including payloads, recording paths, appending "
                "it, or granting approval."
            ),
