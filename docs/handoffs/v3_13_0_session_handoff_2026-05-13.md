...
lapi. 49 MAGMA-event-tyyppia kaytossa (48 Sprint 1 substrate-landingissa, +1 BC2 follow-upissa: behavior.capture_refused).
...
of the 49 MAGMA event types (48 at substrate landing + 1 from BC2 follow-up). Run `python tools/audit_v3_13_0_event_surface.py`
...
python tools/audit_v3_13_0_event_surface.py --count-only   # expect: 49 (post-BC2 follow-up; was 48 at substrate landing)
```
...
5. `tools/audit_v3_13_0_event_surface.py` (machine-derives the 49
   MAGMA event types post-BC2; was 48 at substrate landing; run with
