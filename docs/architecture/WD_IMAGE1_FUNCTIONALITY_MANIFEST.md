...
`decision_reference_is_release_decision=false`. The next small step is adding
a local reviewer handoff bundle index tying package, validation, summary, and
bridge-event template digests without transport or approval.
