...
def build_hex_mesh_route_stage_runtime_metrics_smoke(
    ...
    drill_reviewer_handoff_bundle_verifier_summary_template_index_entry_text = (
        repo_root
        / "tools/build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_bundle_verifier_summary_template_index_entry_tests_text = (
        repo_root
        / "tests/tools/test_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_bundle_verifier_summary_template_index_entry_verifier_text = (
        repo_root
        / "tools/verify_route_stage_handoff_verifier_summary_bridge_template_index_entry.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_bundle_verifier_summary_template_index_entry_verifier_tests_text = (
        repo_root
        / "tests/tools/test_verify_route_stage_handoff_verifier_summary_bridge_template_index_entry.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template_text = (
        repo_root
        / "tools/build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template.py"
    ).read_text(encoding="utf-8")
    drill_reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template_tests_text = (
        repo_root
        / "tests/tools/test_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template.py"
    ).read_text(encoding="utf-8")
    docs_text = (repo_root / "docs/API.md").read_text(encoding="utf-8")
    ...
    checks = {
        ...
        "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verifier_present": all(
            ...
            for token in (
                "VERIFICATION_VERSION",
                "bundle_verification_summary_bridge_event_template_index_entry_verification.v1",
                ...
                "artifact_payloads_included",
                "local_paths_recorded",
                "test_route_stage_reviewer_handoff_bundle_verification_summary_template_index_entry_verifier_recomputes_digests_without_authority",
                "bridge-template index entry verification FAILED",
            )
        )
        and (
            drill_verifier_smoke.get(
        ...
        "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verifier_summary_bridge_event_template_index_entry_present": all(
            token
            in "\n".join(
                (
                    drill_reviewer_handoff_bundle_verifier_summary_template_index_entry_text,
            ...
            for token in (
                ...
                "direct_bridge_write_performed",
                "artifact_payloads_included",
                "test_route_stage_reviewer_handoff_bundle_verifier_summary_bridge_template_index_entry_ties_digests_without_authority",
            )
        )
        and (
            drill_verifier_smoke.get(
        ...
        "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verifier_summary_bridge_event_template_index_entry_verifier_present": all(
            token
            in "\n".join(
                (
                    drill_reviewer_handoff_bundle_verifier_summary_template_index_entry_verifier_text,
            ...
            for token in (
                "VERIFICATION_VERSION",
                "bridge_event_template_index_entry_verification.v1",
                "verify_route_stage_handoff_verifier_summary_bridge_template_index_entry",
                "source_contract_check",
                "rebuilt_index_entry_check",
                "bridge_event_schema_check",
                "artifact_payloads_included",
                "local_paths_recorded",
                "test_route_stage_handoff_verifier_summary_bridge_template_index_entry_verifier_recomputes_digests_without_authority",
        ...
        "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verifier_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_present": all(
            token
            in "\n".join(
                (
                    drill_reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template_text,
            ...
            for token in (
                ...
                "artifact_payloads_included",
                "local_paths_recorded",
                "test_route_stage_reviewer_handoff_bundle_verifier_summary_verification_summary_bridge_event_template_validates_schema",
            )
        )
        and (
            drill_verifier_smoke.get(
    ...
    return {
        **base,
        ...
        "latency_feed_drill_evidence_reviewer_handoff_bundle_verifier_summary_bridge_event_template_index_entry_supported": checks[
            "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verifier_summary_bridge_event_template_index_entry_present"
        ],
        "latency_feed_drill_evidence_reviewer_handoff_bundle_verifier_summary_bridge_event_template_index_entry_verifier_supported": checks[
            "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verifier_summary_bridge_event_template_index_entry_verifier_present"
        ],
        "latency_feed_drill_evidence_reviewer_handoff_bundle_verifier_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_supported": checks[
            "ops_latency_feed_drill_evidence_reviewer_handoff_bundle_verifier_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_present"
        ],
        ...
        "safe_conclusion": (
            ...
            "and verifier for the verifier chain, plus a local index entry "
            "for the reviewer handoff bundle verifier-summary bridge-event "
            "template, a local verifier for that index entry, plus a "
            "template-only bridge-event renderer for that index-entry "
            "verifier summary, without storing raw query, profile, language, "
...
def _build_route_stage_feed_health_drill_evidence_verifier_smoke() -> dict:
    try:
        ...
        from tools.verify_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry import (
            EVENT_STATUS as DRILL_REVIEWER_HANDOFF_BUNDLE_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_STATUS,
        ...
        from tools.build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry import (
            EVENT_STATUS as DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_BRIDGE_EVENT_TEMPLATE_STATUS,
            INDEX_ENTRY_VERSION as DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERSION,
            SUMMARY_ARTIFACT_ID as DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_ARTIFACT_ID,
            SUMMARY_VERSION as DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_VERSION,
            TEMPLATE_ARTIFACT_ID as DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_BRIDGE_EVENT_TEMPLATE_ARTIFACT_ID,
            TEMPLATE_VERSION as DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_BRIDGE_EVENT_TEMPLATE_VERSION,
            VERIFICATION_KEY as DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_VERIFICATION_KEY,
            build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry,
        )
        ...
        from tools.build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary import (
            SUMMARY_VERSION as DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_VERSION,
            VERIFICATION_KEY as DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_TEMPLATE_INDEX_ENTRY_VERIFICATION_KEY,
            VERIFICATION_VERSION as DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_TEMPLATE_INDEX_ENTRY_VERIFICATION_VERSION,
        ...
        from tools.build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template import (
            EVENT_STATUS as DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_STATUS,
            TEMPLATE_VERSION as DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_VERSION,
            build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template,
        )
        ...
        return {
            ...
            "reviewer_handoff_bundle_verifier_summary_bridge_event_template_index_entry_smoke": {
                "ok": False,
                "blocked_reason": f"reviewer_handoff_bundle_verifier_summary_bridge_event_template_index_entry_import_failed:{exc.__class__.__name__}",
                "index_entry_version": None,
                "direct_bridge_write_performed": False,
            },
            "reviewer_handoff_bundle_verifier_summary_bridge_event_template_index_entry_verification_summary_smoke": {
                "ok": False,
                "blocked_reason": f"reviewer_handoff_bundle_verifier_summary_bridge_event_template_index_entry_verification_summary_import_failed:{exc.__class__.__name__}",
                "summary_version": None,
                "direct_bridge_write_performed": False,
            },
            "reviewer_handoff_bundle_verifier_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_smoke": {
                "ok": False,
                "blocked_reason": f"reviewer_handoff_bundle_verifier_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_import_failed:{exc.__class__.__name__}",
                "template_version": None,
                "direct_bridge_write_performed": False,
            },
    ...
    reviewer_handoff_bundle_verification_summary = {
        ...
        "route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification": {
            ...
            "bundle_index_version": reviewer_handoff_bundle_index_verification.get(
                "bundle_index_version"
            ),
            "artifact_count_checked": reviewer_handoff_bundle_index_verification.get(
            ...
            "size_checks": reviewer_handoff_bundle_index_verification.get(
                "size_checks",
                {},
            ),
            "schema_version_checks": reviewer_handoff_bundle_index_verification.get(
        ...
        "operator_boundary": no_authority_boundary,
    ...
    reviewer_handoff_bundle_verification_summary_template_payload = {
        ...
        "route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification": reviewer_handoff_bundle_verification_summary[
            "route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification"
        ],
        "operator_boundary": no_authority_boundary,
        "template_only": True,
    ...
    reviewer_handoff_bundle_verification_summary_template = {
        ...
        "bridge_event_template": {
            ...
            "status": (
                DRILL_REVIEWER_HANDOFF_BUNDLE_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_STATUS
            ),
            "severity": "medium",
            "to": "operator,claude-rco-1,codex-tools-1",
            "message": (
    ...
    reviewer_handoff_bundle_verification_summary_template_index_entry_verification = verify_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry(
        index_entry=(
            reviewer_handoff_bundle_verification_summary_template_index_entry
        ),
        bundle_verification_summary=(
            reviewer_handoff_bundle_verification_summary
        ),
    ...
    reviewer_handoff_bundle_verifier_summary = {
        "proof_id": (
            "route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_"
        ...
        "ok": True,
        "summary_version": DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_VERSION,
        ...
        DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_VERIFICATION_KEY: {
            "verification_ok": True,
            "verification_version": (
    ...
    reviewer_handoff_bundle_verifier_summary_template_payload = {
        "schema_version": (
            DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_BRIDGE_EVENT_TEMPLATE_VERSION
        ),
        "summary_version": DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_VERSION,
        "summary_proof_id": reviewer_handoff_bundle_verifier_summary["proof_id"],
        "reviewer_ownership": reviewer_handoff_bundle_verifier_summary[
            "reviewer_ownership"
        ],
        DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_VERIFICATION_KEY: (
            reviewer_handoff_bundle_verifier_summary[
        ...
        "operator_boundary": reviewer_handoff_bundle_verifier_summary[
            "operator_boundary"
        ],
        "template_only": True,
        "manual_review_required": True,
    ...
    reviewer_handoff_bundle_verifier_summary_template = {
        "proof_id": (
            "route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_"
            "verification_summary_bridge_event_template_index_entry_"
            "verification_summary_bridge_event_template_v1"
        ...
        "bridge_event_template": {
            ...
            "status": (
                DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_BRIDGE_EVENT_TEMPLATE_STATUS
            ),
            "severity": "medium",
            "to": "operator,claude-rco-1,codex-tools-1",
            "message": (
            ...
            "pid": 0,
            "cwd": "template_not_emitted",
            "payload": reviewer_handoff_bundle_verifier_summary_template_payload,
        },
        "template_only": True,
        "manual_review_required": True,
        **no_authority_fields,
    ...
    reviewer_handoff_bundle_verifier_summary_bytes = json.dumps(
        reviewer_handoff_bundle_verifier_summary,
        ensure_ascii=True,
        separators=(",", ":"),
        sort_keys=True,
    ).encode("utf-8")
    reviewer_handoff_bundle_verifier_summary_template_bytes = json.dumps(
        reviewer_handoff_bundle_verifier_summary_template,
        ensure_ascii=True,
        separators=(",", ":"),
        sort_keys=True,
    ).encode("utf-8")
    reviewer_handoff_bundle_verifier_summary_template_index_entry = build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry(
        index_entry_verification_summary=reviewer_handoff_bundle_verifier_summary,
        summary_bridge_event_template_report=(
            reviewer_handoff_bundle_verifier_summary_template
        ),
        index_entry_verification_summary_bytes=(
            reviewer_handoff_bundle_verifier_summary_bytes
        ),
        summary_bridge_event_template_bytes=(
            reviewer_handoff_bundle_verifier_summary_template_bytes
        ),
    )
    reviewer_handoff_bundle_verifier_summary_template_index_entry_verification = verify_route_stage_handoff_verifier_summary_bridge_template_index_entry(
        index_entry=reviewer_handoff_bundle_verifier_summary_template_index_entry,
        index_entry_verification_summary=reviewer_handoff_bundle_verifier_summary,
        summary_bridge_event_template_report=(
            reviewer_handoff_bundle_verifier_summary_template
        ),
    ...
    reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary = build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary(
        verification_report=(
            reviewer_handoff_bundle_verifier_summary_template_index_entry_verification
        ),
        reviewer_agent_id="claude-rco-1",
        handoff_ref=(
            "bridge:handoff:route-stage-reviewer-handoff-bundle-"
    ...
    reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template = build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template(
        summary=(
            reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary
        ),
        agent_id="codex-lead-1",
    ...
    reviewer_handoff_bundle_verification_summary_template_index_entry_verification_smoke = {
        "ok": (
            reviewer_handoff_bundle_verification_summary_template_index_entry_verification.get(
                "ok"
            )
        ...
        "index_entry_version": reviewer_handoff_bundle_verification_summary_template_index_entry_verification.get(
            "index_entry_version"
        ),
    ...
    reviewer_handoff_bundle_verifier_summary_template_index_entry_record = (
        reviewer_handoff_bundle_verifier_summary_template_index_entry.get(
            "template_index_entry",
            {},
        )
    )
    reviewer_handoff_bundle_verifier_summary_template_index_entry_boundary = (
        reviewer_handoff_bundle_verifier_summary_template_index_entry.get(
            "operator_boundary",
            {},
        )
    ...
    reviewer_handoff_bundle_verifier_summary_template_index_entry_smoke = {
        "ok": (
            reviewer_handoff_bundle_verifier_summary_template_index_entry.get("ok")
            is True
            and reviewer_handoff_bundle_verifier_summary_template_index_entry.get(
                "index_entry_version"
            )
            == DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERSION
            and reviewer_handoff_bundle_verifier_summary_template_index_entry_record.get(
                "template_only"
            )
            is True
            and reviewer_handoff_bundle_verifier_summary_template_index_entry_record.get(
            ...
            is False
            and reviewer_handoff_bundle_verifier_summary_template_index_entry_boundary.get(
                "manual_review_required"
            )
            is True
            and reviewer_handoff_bundle_verifier_summary_template_index_entry_boundary.get(
        ...
        "index_entry_version": reviewer_handoff_bundle_verifier_summary_template_index_entry.get(
            "index_entry_version"
        ),
        "template_only": reviewer_handoff_bundle_verifier_summary_template_index_entry.get(
            "template_only"
        ),
        "manual_review_required": reviewer_handoff_bundle_verifier_summary_template_index_entry.get(
            "manual_review_required"
        ),
        "source_contract_check": reviewer_handoff_bundle_verifier_summary_template_index_entry_record.get(
            "source_contract_check"
        ),
        "rebuilt_template_check": reviewer_handoff_bundle_verifier_summary_template_index_entry_record.get(
            "rebuilt_template_check"
        ),
        "direct_bridge_write_performed": reviewer_handoff_bundle_verifier_summary_template_index_entry.get(
            "direct_bridge_write_performed"
        ),
        "artifact_payloads_included": reviewer_handoff_bundle_verifier_summary_template_index_entry.get(
            "artifact_payloads_included"
        ),
        "local_paths_recorded": reviewer_handoff_bundle_verifier_summary_template_index_entry.get(
            "local_paths_recorded"
        ),
        "network_access_performed": reviewer_handoff_bundle_verifier_summary_template_index_entry.get(
            "network_access_performed"
        ),
        "blockers": reviewer_handoff_bundle_verifier_summary_template_index_entry.get(
            "blockers",
            [],
        ),
    }
    reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_smoke = {
        "ok": (
            reviewer_handoff_bundle_verifier_summary_template_index_entry_verification.get(
                "ok"
            )
            is True
            and reviewer_handoff_bundle_verifier_summary_template_index_entry_verification.get(
                "verification_version"
            )
            == DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_TEMPLATE_INDEX_ENTRY_VERIFICATION_VERSION
            and reviewer_handoff_bundle_verifier_summary_template_index_entry_verification.get(
                "index_entry_version"
            )
            == DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_BRIDGE_EVENT_TEMPLATE_INDEX_ENTRY_VERSION
        ...
        "verification_version": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification.get(
            "verification_version"
        ),
        "index_entry_version": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification.get(
            "index_entry_version"
        ),
        "source_contract_check": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification.get(
            "source_contract_check"
        ),
        "rebuilt_index_entry_check": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification.get(
            "rebuilt_index_entry_check"
        ),
        "bridge_event_schema_check": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification.get(
            "bridge_event_schema_check"
        ),
        "digest_checks": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification.get(
            "digest_checks",
            {},
        ),
        "direct_bridge_write_performed": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification.get(
            "direct_bridge_write_performed"
        ),
        "artifact_payloads_included": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification.get(
            "artifact_payloads_included"
        ),
        "local_paths_recorded": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification.get(
            "local_paths_recorded"
        ),
        "network_access_performed": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification.get(
            "network_access_performed"
        ),
        "blockers": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification.get(
            "blockers",
            [],
        ),
    }
    reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_payload = (
        reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary.get(
            DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_TEMPLATE_INDEX_ENTRY_VERIFICATION_KEY,
            {},
        )
    )
    reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_boundary = (
        reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary.get(
            "operator_boundary",
            {},
        )
    ...
    reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_smoke = {
        "ok": (
            ...
            is True
            and reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary.get(
                "summary_version"
            )
            == DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_VERSION
            and reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_payload.get(
                "verification_version"
            )
            == DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_TEMPLATE_INDEX_ENTRY_VERIFICATION_VERSION
            and reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_payload.get(
            ...
            == "match"
            and reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_boundary.get(
                "verification_report_boundary_ok"
            )
            is True
            and reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary.get(
        ...
        "summary_version": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary.get(
            "summary_version"
        ),
        "verification_version": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_payload.get(
            "verification_version"
        ),
        "index_entry_version": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_payload.get(
            "index_entry_version"
        ),
        "source_contract_check": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_payload.get(
            "source_contract_check"
        ),
        "rebuilt_index_entry_check": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_payload.get(
            "rebuilt_index_entry_check"
        ),
        "bridge_event_schema_check": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_payload.get(
            "bridge_event_schema_check"
        ),
        "direct_bridge_write_performed": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary.get(
            "direct_bridge_write_performed"
        ),
        "artifact_payloads_included": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary.get(
            "artifact_payloads_included"
        ),
        "local_paths_recorded": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary.get(
            "local_paths_recorded"
        ),
        "network_access_performed": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary.get(
            "network_access_performed"
        ),
        "blockers": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary.get(
            "blockers",
            [],
        ),
    }
    reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template_event = (
        reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template.get(
            "bridge_event_template",
            {},
        )
    )
    reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template_payload = (
        reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template_event.get(
            "payload"
        )
        if isinstance(
            reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template_event,
    ...
    reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template_boundary = (
        reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template_payload.get(
            "operator_boundary"
        )
        if isinstance(
            reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template_payload,
    ...
    reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_bridge_event_template_smoke = {
        "ok": (
            ...
            is True
            and reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template.get(
                "template_version"
            )
            == DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_VERSION
            and isinstance(
                reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template_event,
                dict,
            )
            and reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template_event.get(
                "status"
            )
            == DRILL_REVIEWER_HANDOFF_VERIFIER_SUMMARY_TEMPLATE_INDEX_ENTRY_VERIFICATION_SUMMARY_BRIDGE_EVENT_TEMPLATE_STATUS
            and reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template_event.get(
                "cwd"
            )
            == "template_not_emitted"
            ...
            == []
            and reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template_payload.get(
                "template_only"
            )
            is True
            and reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template_boundary.get(
                "manual_review_required"
            )
            is True
            and reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template_boundary.get(
        ...
        "template_version": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template.get(
            "template_version"
        ),
        "template_only": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template.get(
            "template_only"
        ),
        "manual_review_required": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template.get(
            "manual_review_required"
        ),
        "direct_bridge_write_performed": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template.get(
            "direct_bridge_write_performed"
        ),
        "artifact_payloads_included": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template.get(
            "artifact_payloads_included"
        ),
        "local_paths_recorded": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template.get(
            "local_paths_recorded"
        ),
        "network_access_performed": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template.get(
            "network_access_performed"
        ),
        "blockers": reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_template.get(
            "blockers",
            [],
        ),
    }
    ...
    return {
        "ok": (
            ...
            and reviewer_handoff_bundle_verification_summary_template_index_entry_verification_smoke[
                "ok"
            ]
            is True
            and reviewer_handoff_bundle_verifier_summary_template_index_entry_smoke[
                "ok"
            ]
            is True
            and reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_smoke[
                "ok"
            ]
            is True
            and reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_smoke[
                "ok"
            ]
            is True
            and reviewer_handoff_bundle_verifier_summary_template_index_entry_verification_summary_bridge_event_template_smoke[
                "ok"
            ]
            is True
        ),
...
def _hex_upgrade_cross_consistency_bridge_event_template_index_entry(
    ...
    return _hex_upgrade_cross_consistency_bridge_event_template_index_entry_bundle(
        digest
    )[0]


def _hex_upgrade_cross_consistency_bridge_event_template_index_entry_bundle(
    digest: Mapping[str, Any] | None,
    ...
    template from the digest, passes deterministic bytes to the indexer, and
    verifies the same in-memory index entry so the manifest never stores the raw
    bridge-event template itself.
    """
    from tools.build_hex_upgrade_cross_consistency_digest_bridge_event_template import (  # noqa: E402
        build_hex_upgrade_cross_consistency_digest_bridge_event_template as _build_xcons_tpl,
    )
    ...
    from tools.verify_hex_upgrade_cross_consistency_digest_bridge_event_template_index_entry import (  # noqa: E402
        verify_hex_upgrade_cross_consistency_digest_bridge_event_template_index_entry as _verify_xcons_tpl_index,
    )
    ...
    index_entry = _build_xcons_tpl_index(
        bridge_event_template_report=template_report,
        bridge_event_template_bytes=template_bytes,
    )
    verification = _verify_xcons_tpl_index(
...
def _hex_upgrade_cross_consistency_bridge_event_template_index_entry_verification_summary_bridge_event_template(
    summary: Mapping[str, Any] | None,
) -> dict[str, Any]:
    """Render a template-only bridge event for the hex xcons verifier summary."""
    ...
    from tools.build_hex_upgrade_cross_consistency_digest_bridge_event_template_index_entry_verification_summary_bridge_event_template import (  # noqa: E402
        build_hex_upgrade_cross_consistency_digest_bridge_event_template_index_entry_verification_summary_bridge_event_template as _build_template,
    )
...
def _hex_upgrade_cross_consistency_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry(
    summary: Mapping[str, Any] | None,
    template_report: Mapping[str, Any] | None,
) -> dict[str, Any]:
    """Build a local index entry for the hex xcons verifier-summary template."""
    ...
    from tools.build_hex_upgrade_cross_consistency_digest_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry import (  # noqa: E402
        build_hex_upgrade_cross_consistency_digest_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry as _build_index_entry,
    )
...
def _hex_upgrade_cross_consistency_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary(
    verification: Mapping[str, Any] | None,
) -> dict[str, Any]:
    """Render local reviewer context for the hex xcons verifier-summary index verifier."""
    ...
    from tools.build_hex_upgrade_cross_consistency_digest_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary import (  # noqa: E402
        build_hex_upgrade_cross_consistency_digest_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary as _build_summary,
    )
...
def _capabilities(root: Path) -> tuple[Capability, ...]:
    hex_evidence = _evidence(
        ...
        (
            ...
            (
                "tools/build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry.py",
                "Local index entry for the route-stage feed-health reviewer handoff bundle verifier-summary bridge-event template.",
            ),
            (
                ...
                "Path-free verifier summary renderer for the route-stage feed-health reviewer handoff bundle verifier-summary bridge-event template index entry.",
            ),
            (
                "tools/build_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary_bridge_event_template.py",
                "Template-only bridge-event renderer for the route-stage feed-health reviewer handoff bundle verifier-summary bridge-event template index-entry verifier summary.",
            ),
        ),
    )
    ...
    hex_upgrade_evidence = _evidence(
        ...
        (
            ...
            (
                "tools/verify_hex_upgrade_cross_consistency_digest_bridge_event_template_index_entry.py",
            ...
            (
                "tools/build_hex_upgrade_cross_consistency_digest_bridge_event_template_index_entry_verification_summary_bridge_event_template.py",
                "Template-only bridge-event renderer for the hex-upgrade cross-consistency digest bridge-event template index-entry verification summary; no append, payload inclusion, path recording, transport, claim upgrade, or runtime subdivision authority.",
            ),
            (
                "tools/build_hex_upgrade_cross_consistency_digest_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry.py",
            ...
            (
                "tools/build_hex_upgrade_cross_consistency_digest_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary.py",
                "Path-free reviewer summary renderer for the hex-upgrade verifier-summary bridge-event template index-entry verifier result; no payload inclusion, path recording, bridge append, transport, claim upgrade, or runtime subdivision authority.",
            ),
            (
            ...
            (
                "tests/test_build_hex_upgrade_cross_consistency_digest_bridge_event_template_index_entry_verification_summary_bridge_event_template.py",
                "Verifier-summary bridge-event template tests prove schema-valid handoff JSON, path-free CLI output, no-authority axes, and fail-closed unsafe input handling.",
            ),
            (
            ...
            (
                ...
                "Verifier-summary bridge-event template index-entry verifier-summary tests prove path-free reviewer context, no-authority axes, no payload/path echo, and fail-closed drift handling.",
            ),
        ),
    )
    ...
    # Path-free local verifier for the digest template INDEX ENTRY. Built AFTER the
    # hex ok recompute and NOT folded into ok; measurement-only, no payloads/paths,
    # bridge writes, transport, claim upgrade, or runtime subdivision authority.
    hex_upgrade_proof[
    ...
    # Template-only bridge-event renderer for that verifier summary. Built AFTER
    # the hex ok recompute and NOT folded into ok; measurement-only, no append,
    # payloads/paths, transport, claim upgrade, or runtime subdivision authority.
    hex_upgrade_cross_consistency_digest_bridge_event_template_index_entry_verification_summary_bridge_event_template = _hex_upgrade_cross_consistency_bridge_event_template_index_entry_verification_summary_bridge_event_template(
        hex_upgrade_proof[
            "cross_consistency_digest_bridge_event_template_index_entry_verification_summary"
        ]
    )
    ...
    # Local index entry for that verifier-summary bridge-event template. Built
    ...
    # Path-free local reviewer summary for that verifier-summary bridge-event
    # template index-entry verifier result. Built AFTER the hex ok recompute and
    # NOT folded into ok; measurement-only, no append, payloads/paths, transport,
    # claim upgrade, or runtime subdivision authority.
    hex_upgrade_proof[
    ...
    ] = _hex_upgrade_cross_consistency_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification_summary(
        hex_upgrade_proof[
            "cross_consistency_digest_bridge_event_template_index_entry_verification_summary_bridge_event_template_index_entry_verification"
        ]
    )
    ...
    return (
        Capability(
            ...
            safe_statement=(
                ...
                "handoff bundle index and verifier for that summary, plus a "
                "local index entry for the reviewer handoff bundle "
                "verifier-summary bridge-event template and a path-free "
                "verifier-summary renderer for that template index entry; "
                "exact runtime entry "
            ...
            next_smallest_pr=(
                "Add a local verifier for the route-stage feed-health reviewer "
                "handoff bundle verifier-summary bridge-event template index "
                "entry without including payloads, recording paths, appending "
                "it, or granting runtime authority."
            ),
        ...
        Capability(
            ...
            safe_statement=(
                ...
                "authority. A local verifier for that digest template index "
                "entry recomputes digest, size, schema, source-contract, "
                "rebuilt-entry, and bridge-event schema checks while keeping "
                "payload inclusion, local path recording, bridge writes, "
                ...
                "subdivision authority. A template-only bridge-event renderer "
                "can turn that verification summary into schema-valid handoff "
                "JSON while preserving the same no-append, no-payload, "
                "no-path, no-transport, no-claim-upgrade, and no-runtime-"
                "subdivision-authority boundary."
                " A local index entry can bind that verification-summary "
                "bridge-event template and source summary digests with "
                ...
                "upgrades, and runtime subdivision authority false. A "
                "path-free verifier-summary renderer can turn that index "
                "entry verifier result into local reviewer context without "
                "including payloads, recording paths, appending bridge "
                "events, transporting artifacts, upgrading claims, or "
            ...
            next_smallest_pr=(
                "Add a template-only bridge-event renderer for the hex-upgrade "
                "cross-consistency digest bridge-event template index-entry "
                "verification summary bridge-event template index-entry "
                "verifier-summary without including payloads/paths, "
                "appending it, transporting artifacts, upgrading claims, or "
                "granting runtime subdivision authority."
            ),
