...
"""Verify a route-stage handoff-bundle summary bridge-template index entry."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.json or report["ok"]:
        ...
        print(
            "route-stage handoff-bundle summary bridge-template index "
...
def verify_route_stage_feed_health_drill_evidence_reviewer_handoff_bundle_verification_summary_bridge_event_template_index_entry(
    *,
    ...
    """Recompute checks for the handoff-bundle template index entry."""
...
def _assert_no_forbidden_output(text: str) -> None:
    if _forbidden_output_markers(text):
        raise ValueError(
            ...
            "entry verification contains forbidden markers"
        )
