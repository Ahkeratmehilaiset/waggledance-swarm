...
**Freshness audit:** 2026-06-15 read-only audit, following the 2026-06-11, 2026-06-06, and 2026-05-27 read-only audits, found the dated PROVEN/MEASURED evidence older than the dream-mode <=14-day freshness target. On 2026-06-15, the referenced global matrix evidence band is 40 days old, and the G/J/L priority rows are also 40 days old. Labels below remain historical evidence labels until refreshed; these audits do not upgrade or invalidate any row.
**Freshness metadata:** `snapshot_date=2026-05-06`; `freshness_audit_date=2026-06-15`; `prior_freshness_audit_date=2026-06-11`; `max_age_days=14`; `status=historical_stale`; `fresh_for_planning=false`; `priority_rows=G,J,L`; `priority_rows_snapshot_date=2026-05-06`; `priority_rows_freshness_audit_date=2026-06-15`; `priority_rows_fresh_for_planning=false`; `historical_labels_until_refreshed=true`.
