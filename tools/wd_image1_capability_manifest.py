    ...
    return (
        ...
        Capability(
            ...
            gaps=(
                ...
                "verifier add reviewer context, and none of them transport "
                "payloads, append bridge events, record local paths, upgrade "
                "claims, or grant runtime subdivision authority.",
            ),
            next_smallest_pr=(
