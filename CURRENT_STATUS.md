...
**Updated:** 2026-05-04
**Version:** **v3.8.0 stable** (released 2026-05-04 from Phase 16F, PR #68 squash-merge `824176eb`).
**Shipped branch:** `main` at `824176eb...` (Phase 16F squash-merge of [PR #68](https://github.com/Ahkeratmehilaiset/waggledance-swarm/pull/68)). Earlier history: Phase 16D squash-merge of [PR #66](https://github.com/Ahkeratmehilaiset/waggledance-swarm/pull/66) at `7210a7e`; Phase 16C squash-merge of [PR #65](https://github.com/Ahkeratmehilaiset/waggledance-swarm/pull/65) at `b87fbe4`; Phase 16B squash-merge of [PR #64](https://github.com/Ahkeratmehilaiset/waggledance-swarm/pull/64) at `bada64c`; Phase 16A squash-merge of [PR #63](https://github.com/Ahkeratmehilaiset/waggledance-swarm/pull/63) at `d18e1da`; Phase 15 squash-merge of [PR #62](https://github.com/Ahkeratmehilaiset/waggledance-swarm/pull/62) at `2b9978d`; Phase 10 squash-merge of [PR #54](https://github.com/Ahkeratmehilaiset/waggledance-swarm/pull/54) at `08b7e8c` on top of `8bf1869` on top of `a1c4152` (PR #51 squash).
**Latest tag (GitHub Latest):** [`v3.8.0`](https://github.com/Ahkeratmehilaiset/waggledance-swarm/releases/tag/v3.8.0) — first stable release. The previous prerelease [`v3.7.8-docker-gate-alpha`](https://github.com/Ahkeratmehilaiset/waggledance-swarm/releases/tag/v3.7.8-docker-gate-alpha) (Phase 16D) remains visible as a Pre-release entry; not moved or retagged.
**CI status:** 🟢 main push-event CI green from PR #67 merge commit `86cde948` onward. [PR #67](https://github.com/Ahkeratmehilaiset/waggledance-swarm/pull/67) (`fix/ci-fetch-depth-truth-regression`) squash-merged 2026-05-04T08:14:49Z; adds `fetch-depth: 0` to `actions/checkout` in `.github/workflows/ci.yml` and `.github/workflows/tests.yml` so `tests/phase10/test_truth_regression.py::test_phase10_branch_history_is_linear_descended_from_main` can resolve the recorded Phase 10 squash SHA via `merge-base --is-ancestor` instead of failing on a depth-1 shallow clone. PR #67 changed only workflow files (4 lines, 2 files); no autonomy code touched. v3.8.0 stable tag and release unchanged (target still `824176eb`, `isPrerelease=false`, GitHub Latest).
