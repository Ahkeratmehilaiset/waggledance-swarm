    ...
    return (
        ...
        Capability(
            ...
            safe_statement=(
                ...
                "bridge writes, or approval automation; hard append-only/"
                "default enforcement is still not yet safe to claim."
            ),
            ...
            next_smallest_pr=(
                "Add a local operator decision-reference review bundle verifier "
