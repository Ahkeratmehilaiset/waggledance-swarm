...
IDs only. It does not expose provider exception details, local paths, payloads,
or controls. The next small step is peer-review handoff provider
freshness/retention alert thresholds without adding runtime controls.
