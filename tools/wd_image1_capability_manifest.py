    ...
    return {
        **base,
        ...
        "safe_conclusion": (
            ...
            "and a local index entry plus verifier for that renderer "
    ...
    return (
        Capability(
            ...
            safe_statement=(
                ...
                "that renderer; exact runtime entry order depends on flags "
                "and call path."
            ),
            ...
            next_smallest_pr=(
                ...
                "entry verifier without including payloads, recording paths, "
